...
author: karim
comments: true
date: 2012-10-27 19:42:30+00:00
layout: post
slug: cant-set-x520-10gbe-intel-nic-to-auto-negotiate-on-esxi
...
We decided to try out the latest driver. [Here](https://my.vmware.com/web/vmware/details?downloadGroup=DT-ESX4X-Intel-ixgbe-3913&productId=230) is the link to the ixgbe 3.9.13 driver for ESX(i) 4.x. We read over the instructions laid out in the VMware KB Entitled [Installing async drivers on ESX/ESXi 4.x](http://kb.vmware.com/kb/1032936) and here are the instructions from the KB:
