...
![FUT AWS Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-FUT_AWS.png)

From the same PDF here are some limitations:

![FUT Usage Limits Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-FUT_Usage_Limits.png)
...
![sign up aws Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-sign_up_aws.png)
...
![aws account Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-aws_account.png)

And then Click on "Account Activity" and you will see the following:

![FUT Eligible Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-FUT_Eligible.png)
...
![aws my account console Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-aws_my_account_console.png)


From the Drop Down Menu select "AWS Management Console", and that will bring you to the following page:

![aws mgmt console Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-aws_mgmt_console.png)
...
![EC2 Dashboard Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-EC2_Dashboard.png)

To create a new EC2 instance click on the "Launch Instance" button:

![create instance Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-create_instance.png)

You will then be presented with a choice of wizards:

![New Instance Wizard Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-New_Instance_Wizard.png)
...
![select AMI Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-select_AMI.png)
...
![Instance details Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-Instance_details.png)
...
![adv inst opt Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-adv_inst_opt.png)

After clicking "Continue", I was presented with the "Storage Device Configuration" page:

![storage dev conf Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-storage_dev_conf.png)
...
![EBS Volumes New Instance Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-EBS_Volumes_New_Instance.png)
...
![Provisioned IOPS g Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-Provisioned_IOPS_g.png)
...
![Tags New Instance Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-Tags_New_Instance.png)
...
![Create new Key Pair Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-Create_new_Key_Pair.png)
...
![create new security group Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-create_new_security_group.png)

After I clicked "Continue" I was presented with the Summary of all the Settings:

![Review new instance Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-Review_new_instance.png)

After I clicked "Launch" I was presented with the following dialog:

![Instance is launching Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-Instance_is_launching.png)

I then went to the EC2 Dashboard and selected "Instances" and I saw the following:

![ec2 intances Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-ec2_intances.png)
...
![EIPs Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-EIPs.png)

I then clicked on "Allocate New Address" and the following dialog popped up:

![Allow new EIP Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-Allow_new_EIP.png)

I left the defaults and then clicked on "Yes, Allocate" and then under "Elastic IPs" the new IP showed up:

![New EIP Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-New_EIP.png)
...
![Associate EIP with Ec2 instance Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-Associate_EIP_with_Ec2_instance.png)
...
![EIP Associated Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-EIP_Associated.png)
...
![AWS Service charges Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-AWS_Service_charges.png)
...
![Instance metrics Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-Instance_metrics.png)
...
![create an alarm g Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-create_an_alarm_g.png)
...
![Alarm net out 1gb 6 hours Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-Alarm-net-out-1gb-6-hours.png)
...
![Successful alarm creation Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-Successful_alarm_creation.png)
...
![cloud watch dashboard Deploy an Amazon EC2 instance in the Free Usage Tier](http://assets.virtuallyhyper.com/2013-03-cloud_watch_dashboard.png)
