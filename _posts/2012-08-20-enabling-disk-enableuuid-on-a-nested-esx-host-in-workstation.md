...
author: karim
comments: true
date: 2012-08-20 16:39:37+00:00
layout: post
slug: enabling-disk-enableuuid-on-a-nested-esx-host-in-workstation
...
[![](http://virtuallyhyper.com/wp-content/uploads/2012/08/boot-issue-after-enableuuid.png)](http://virtuallyhyper.com/wp-content/uploads/2012/08/boot-issue-after-enableuuid.png)
...
Now let's go ahead and store those values in variables and use sed to update the _esx.conf_ file accordingly:
...
Whenever you forcefully mount a VMFS volume the following settings are added to the _/etc/vmware/esx.conf_ file:
