...
![vma commands VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-vma_commands.png)
...
![vma download VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-vma_download.png)
...
![vma zip file VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-vma_zip_file.png)

After extracting the archive, you will see the following files:

![zip extracted vma VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-zip_extracted_vma.png)

Now to deploy the 'ovf', we can go to "File -> Deploy OVF Template":

![deploy ovf template VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-deploy_ovf_template.png)

Browsing to our ovf and selecting it, we get this from vCenter:
![deploy ovf template vma VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-deploy_ovf_template_vma.png)

Keep Clicking through the Deployment Wizard:

![deploy ovf vma wizard VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-deploy_ovf_vma_wizard.png)

At end the final screen will look like this:

![final screen ovf vma VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-final_screen_ovf_vma.png)

After the VM is Deployed, you will see it in the inventory:

![vma vm vc inventory VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-vma_vm_vc_inventory.png)
...
![first boot vma VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-first_boot_vma.png)

Here is how you can set the IP for the vMA:

![ip conf vma VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-ip_conf_vma.png)

After the boot up process is finished, you will see the following screen on the vMA VM:

![vma finish boot VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-vma_finish_boot.png)

Also visiting the management console from the Browser, I saw the following:

![vma browser VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-vma_browser.png)

Upon logging into the vMA, I the following screen:

![vma browser login VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-vma_browser_login.png)

I tried to login to the vMA via ssh, but I kept the following error in putty:

![vma ssh fail VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-vma_ssh_fail.png)

I logged in via the VM Console and checked out the messages file and I saw the following:

![tcp wrappers vma login VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-tcp_wrappers_vma_login.png)
...
![vma update page VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-vma_update_page.png)

Then checking out the Repository settings:

![repository settings vma VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-repository_settings_vma.png)
...
>
> ![troubleshooting vma VCAP5 DCA Objective 8.2 – Administer vSphere Using the vSphere Management Assistant ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-troubleshooting_vma.png)
>
