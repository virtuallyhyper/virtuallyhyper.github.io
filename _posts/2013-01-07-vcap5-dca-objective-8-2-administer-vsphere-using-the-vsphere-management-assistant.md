...
author: karim
comments: true
date: 2013-01-07 14:10:01+00:00
layout: post
slug: vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant
title: 'VCAP5-DCA Objective 8.2 – Administer vSphere Using the vSphere Management
  Assistant '
wordpress_id: 5573
categories:
- Certifications
...
[![vma_commands](http://virtuallyhyper.com/wp-content/uploads/2012/12/vma_commands.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/vma_commands/)
...
[![vma_download](http://virtuallyhyper.com/wp-content/uploads/2012/12/vma_download.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/vma_download/)
...
[![vma_zip_file](http://virtuallyhyper.com/wp-content/uploads/2012/12/vma_zip_file.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/vma_zip_file/)
...
[![zip_extracted_vma](http://virtuallyhyper.com/wp-content/uploads/2012/12/zip_extracted_vma.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/zip_extracted_vma/)
...
[![deploy_ovf_template](http://virtuallyhyper.com/wp-content/uploads/2012/12/deploy_ovf_template.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/deploy_ovf_template/)
...
[![deploy_ovf_template_vma](http://virtuallyhyper.com/wp-content/uploads/2012/12/deploy_ovf_template_vma.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/deploy_ovf_template_vma/)
...
[![deploy_ovf_vma_wizard](http://virtuallyhyper.com/wp-content/uploads/2012/12/deploy_ovf_vma_wizard.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/deploy_ovf_vma_wizard/)
...
[![final_screen_ovf_vma](http://virtuallyhyper.com/wp-content/uploads/2012/12/final_screen_ovf_vma.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/final_screen_ovf_vma/)
...
[![vma_vm_vc_inventory](http://virtuallyhyper.com/wp-content/uploads/2012/12/vma_vm_vc_inventory.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/vma_vm_vc_inventory/)
...
[![first_boot_vma](http://virtuallyhyper.com/wp-content/uploads/2012/12/first_boot_vma.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/first_boot_vma/)
...
[![ip_conf_vma](http://virtuallyhyper.com/wp-content/uploads/2012/12/ip_conf_vma.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/ip_conf_vma/)
...
[![vma_finish_boot](http://virtuallyhyper.com/wp-content/uploads/2012/12/vma_finish_boot.png)](http://virtuallyhyper.com/wp-content/uploads/2012/12/vma_finish_boot.png)
...
[![vma_browser](http://virtuallyhyper.com/wp-content/uploads/2012/12/vma_browser.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/vma_browser/)
...
[![vma_browser_login](http://virtuallyhyper.com/wp-content/uploads/2012/12/vma_browser_login.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/vma_browser_login/)
...
[![vma_ssh_fail](http://virtuallyhyper.com/wp-content/uploads/2012/12/vma_ssh_fail.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/vma_ssh_fail/)
...
[![tcp_wrappers_vma_login](http://virtuallyhyper.com/wp-content/uploads/2012/12/tcp_wrappers_vma_login.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/tcp_wrappers_vma_login/)
...
>   3. 3 Verify that the target server has been added.
...
>   4. 4 Set the target as the default for the current session:
...
>   5. 5 Verify that you can run a vSphere CLI command without authentication by running a command on one
...
[![vma_update_page](http://virtuallyhyper.com/wp-content/uploads/2012/12/vma_update_page.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/vma_update_page/)
...
[![repository_settings_vma](http://virtuallyhyper.com/wp-content/uploads/2012/12/repository_settings_vma.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/repository_settings_vma/)
...
In our case we will have "gpt" for _DiskLabel_. Moving down the KB we have:
...
Since we want to create just one partition, we will use a value of '1' for _partNum_. Next we have the following:
...
Our _startSector_ will be '2048', since that is the offset for a VMFS-5 partition:
...
Since we are taking up the whole partition the _endSector_ will be the last sector of usable space. We can check that by running the following:
...
So our _endSector_ will  be '272629759'. If we keep going:
...
We are going to be using VMFS so our '_type/guid_' will be "AA31E02A400F11DB9590000C2911D1B8". And lastly:
...
Since we are not going to boot from our VMFS volume, our _attribute_ will be '0'. Now putting everything together, we get the following:
...
[![troubleshooting_vma](http://virtuallyhyper.com/wp-content/uploads/2012/12/troubleshooting_vma.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-8-2-administer-vsphere-using-the-vsphere-management-assistant/troubleshooting_vma/)
