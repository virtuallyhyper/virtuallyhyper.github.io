...
![zabbix web front end setup page Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_web_front_end_setup_page.png)

I then clicked "Next" and I saw the following:

![zabbic web front php setting fail Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbic_web_front_php_setting_fail.png)
...
![zabbix web front php settings pass Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_web_front_php_settings_pass.png)
...
![zabbix web front mysql settings Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_web_front_mysql_settings.png)

Then, I filled out the server connection details:

![zabbix web front server details Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_web_front_server_details.png)

And then I saw the pre-installation summary page:

![zabbix web front summary detail Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_web_front_summary_detail.png)

it then tried to auto create a configuration file under **/etc/zabbix** but it failed:

![zabbix web front install config file Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_web_front_install_config_file.png)
...
![zabbix web front install config file pass Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_web_front_install_config_file_pass.png)

Hitting "Next" yielded the following page:

![zabbix web front login page Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_web_front_login_page.png)
...
![zabbix web front dashboard Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_web_front_dashboard.png)
...
![zabbix web conf hosts Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_web_conf-hosts.png)

Then click on "Create Host" and fill out all the information, mine looked like this:

![zabbix web create host Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_web_create_host.png)

Under the template section choose "Template OS Linux":

![zabbix web create host add template Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_web_create_host_add_template.png)

Then click "Save" and you will see the following:

![zabbix web host added Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_web_host_added.png)
...
![zabbix web graph cpu usage Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_web_graph_cpu_usage.png)

Also going to "Monitoring" -> "Overview" you can see current values for our hosts:

![zabbix monitoring overview Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_monitoring_overview.png)
...
![zabbix add freebsd host Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_add_freebsd_host.png)

And under templates choose, "Template OS FreeBSD":

![zabbix freebsd os template Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_freebsd_os_template.png)

After a little bit of time you should see the host as monitored with a green **Z** under "Configuration" -> "Hosts":

![zabbix freebsd green z Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_freebsd_green_z.png)
...
![zabbix freebsd monitored items Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_freebsd_monitored_items.png)
...
![zabbix all three greenZ Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_all_three_greenZ.png)
...
![zabbix add raid online drives item Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_add_raid_online_drives_item.png)

When finished, click "Save". Then from the same window click on "Graphs" -> "Create Graph" and fill out the information:

![zabbix graph raid disks Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_graph_raid_disks.png)

Then checking out the graph (by going to "Monitoring" -> "Graphs" -> "Host" -> "FreeBSD" -> "Graph" -> "Raid_#_Disks_Online"), here is what I saw:

![zabbix graph disks online Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_graph_disks_online.png)
...
![zabbix item raid cont status Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_item_raid_cont_status.png)
...
![zabbix trigger expression Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_trigger_expression.png)

then click "Save". Your final result will look like this:

![zabbix add trigger Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_add_trigger.png)
...
![zabbix latest data controller status Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_latest_data_controller_status.png)
...
![zabbix trigger fired Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_trigger_fired.png)
...
![zabbix events after issue fixed Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_events_after_issue_fixed.png)
...
*   Works like an Intrusion Detection System (IDS). I installed a new software and it automatically added a new user, I then saw the following under events: ![zabbix password changed Monitor Different Systems with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-zabbix_password_changed.png)
