...
![VMDK Types Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-VMDK_Types.png)
...
![vddk download Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-vddk_download.png)
...
![Download Ovftool Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-Download_Ovftool.png)
...
![OVF Installer Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-OVF_Installer.png)

Just hit "Install" and the process with go through pretty quickly. After it's finished you will see the following:

![OVF Installer Finished Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-OVF_Installer_Finished.png)
...
![OVF VS OVA Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-OVF_VS_OVA.png)
...
![VirtualBox with VM Imported Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-VirtualBox_with_VM_Imported.png)
...
![WIN Boot Error Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-WIN_Boot_Error.png)
...
![Storage Settings after Conversion Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-Storage_Settings_after_Conversion.png)
...
![storage settings to ide Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-storage_settings_to_ide.png)
...
![xp welcome screen Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-xp_welcome_screen.png)
...
![fixboot fixmbr Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-fixboot_fixmbr.png)

That should re-install the MBR on the disk. After I rebooted the error was gone, but it just showed a black screen like so:

![blank screen after fix boot Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-blank-screen-after-fix-boot.png)
...
![storage settings with vista recovery Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-storage_settings_with_vista_recovery.png)

Rebooting the VM and pressing "Enter" at the "Press any key to boot from CD....", I saw the following screen:

![win vista install windows Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-win_vista_install_windows.png)

I then clicked "Next" and saw the following screen:

![vista repair your computer Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-vista_repair_your_computer.png)

Then I clicked "Repair your Computer" and I saw the following:

![vista repair options Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-vista_repair-options.png)

At that screen I clicked "Next" and that yielded this screen:

![vista rec options command prompt Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-vista_rec-options_command_prompt.png)
...
![bootrec vista Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-bootrec_vista.png)
...
![vista mark partition active Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-vista_mark_partition_active.png)

Notice the "*" (star) next to the partition after making it active. Then I rebooted and I saw a successful Windows boot process:

![xp successful boot Migrating a VM from VMware Workstation to Oracle VirtualBox](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-03-xp_successful_boot.png)
