...
And from "[VDI & Storage: Deep Impact](http://assets.virtuallyhyper.com/2014-02-VDI_Storage.pdf)":
...
![raid-with-iops](http://assets.virtuallyhyper.com/2012-08-raid-with-iops.png)
...
![sizing-storage](http://assets.virtuallyhyper.com/2012-08-sizing-storage.png)
...
![prot-comp](http://assets.virtuallyhyper.com/2012-08-prot-comp.png)

And also from "[Storage Considerations for VMware View](http://assets.virtuallyhyper.com/2012-09-view_storage_considerations.pdf)":

![no_of_vm_on_prot](http://assets.virtuallyhyper.com/2012-08-no_of_vm_on_prot.png)
...
![vmware-multi-protocol-storage](http://assets.virtuallyhyper.com/2012-08-vmware-multi-protocol-storage.png)
...
![exchange_storage_setup](http://assets.virtuallyhyper.com/2012-08-exchange_storage_setup.png)
...
![vnx-tiers](http://assets.virtuallyhyper.com/2012-08-vnx-tiers.png)
...
![dmx-vmware-bp](http://assets.virtuallyhyper.com/2012-08-dmx-vmware-bp.png)
...
![vmax-vmware-bp](http://assets.virtuallyhyper.com/2012-08-vmax-vmware-bp.png)
...
![A-P-EVA_and_VMware_BP](http://assets.virtuallyhyper.com/2012-08-A-P-EVA_and_VMware_BP.png).
...
![vnx-vmware-iscsi-bp](http://assets.virtuallyhyper.com/2012-08-vnx-vmware-iscsi-bp.png)
...
![vasa-cap-emc](http://assets.virtuallyhyper.com/2012-08-vasa-cap-emc.png)
...
Lastly from [this](http://assets.virtuallyhyper.com/2013-04-vcap-dcd_notes.pdf) PDF:
...
![cost-comparison-vsa](http://assets.virtuallyhyper.com/2012-08-cost-comparison-vsa.png)
...
![trad-san](http://assets.virtuallyhyper.com/2012-08-trad-san.png)

And here is how the VSA works:

![vsa-san](http://assets.virtuallyhyper.com/2012-08-vsa-san.png)
...
![iso_vs_cons](http://assets.virtuallyhyper.com/2012-08-iso_vs_cons.png)
...
![iops_per_vmfs](http://assets.virtuallyhyper.com/2012-08-iops_per_vmfs.png)

There is a pretty good example from [this](http://assets.virtuallyhyper.com/2013-04-vcap-dcd_notes.pdf) PDF:
...
From "[Fibre Channel SAN Topologies](http://assets.virtuallyhyper.com/2013-01-h8074-fibre-channel-san-tb.pdf)"
...
![san-redundancy](http://assets.virtuallyhyper.com/2012-08-san-redundancy.png)
...
![multiple_links_over_iscsi](http://assets.virtuallyhyper.com/2012-08-multiple_links_over_iscsi.png).
...
![flow-control-nfs](http://assets.virtuallyhyper.com/2012-08-flow-control-nfs.png)
...
![jumbo_frames](http://assets.virtuallyhyper.com/2012-08-jumbo_frames.png)
...
![etherchannel_netapp](http://assets.virtuallyhyper.com/2012-08-etherchannel_netapp.png)

and this:

![ip_hash_with_netapp](http://assets.virtuallyhyper.com/2012-08-ip_hash_with_netapp.png)
...
![fcoe-env](http://assets.virtuallyhyper.com/2012-08-fcoe-env.png)
