...
<p><a href="http://assets.virtuallyhyper.com/2012-08-Add-Computer-account-certificates.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-Add-Computer-account-certificates.png']);"><img class="aligncenter size-full wp-image-1957" title="Add Computer account certificates" src="http://assets.virtuallyhyper.com/2012-08-Add-Computer-account-certificates.png" alt="Add Computer account certificates Installing SRM with custom certificates" width="677" height="469" /></a></p>
<p>When the Certificates Snap-In is added, we want to browse to the &#8220;Trusted Root Certification Authorities -&gt; Certificates&#8221;. In the end we want to see our Root CA Certificate listed here. In my case it is not here, that is why my certificate is not trusted. So we need to import it. Right click on &#8220;Certificates&#8221; and select &#8220;All Tasks-&gt; Import&#8221;.<a href="http://assets.virtuallyhyper.com/2012-08-Import-Certificate-to-Trusted-root.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-Import-Certificate-to-Trusted-root.png']);"><img class="aligncenter size-full wp-image-1958" title="Import Certificate to Trusted root" src="http://assets.virtuallyhyper.com/2012-08-Import-Certificate-to-Trusted-root.png" alt="Import Certificate to Trusted root Installing SRM with custom certificates" width="429" height="320" /></a></p>
...
<p><a href="http://assets.virtuallyhyper.com/2012-08-Import-Certificate-into-Trusted-CA.jpg" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-Import-Certificate-into-Trusted-CA.jpg']);"><img class="aligncenter size-full wp-image-1959" title="Import Certificate into Trusted CA" src="http://assets.virtuallyhyper.com/2012-08-Import-Certificate-into-Trusted-CA.jpg" alt="Import Certificate into Trusted CA Installing SRM with custom certificates" width="503" height="453" /></a></p>
...
<p><a href="http://assets.virtuallyhyper.com/2012-08-Cert-in-trusted-root.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-Cert-in-trusted-root.png']);"><img class="aligncenter size-full wp-image-1960" title="Cert in trusted root" src="http://assets.virtuallyhyper.com/2012-08-Cert-in-trusted-root.png" alt="Cert in trusted root Installing SRM with custom certificates" width="499" height="178" /></a></p>
...
<p><a href="http://assets.virtuallyhyper.com/2012-08-Trusted-Root-CA-Cert.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-Trusted-Root-CA-Cert.png']);"><img class="aligncenter size-full wp-image-1962" title="Trusted Root CA Cert" src="http://assets.virtuallyhyper.com/2012-08-Trusted-Root-CA-Cert.png" alt="Trusted Root CA Cert Installing SRM with custom certificates" width="410" height="508" /></a></p>
...
<p><a href="http://assets.virtuallyhyper.com/2012-08-SRM-install-Step-1-vCenter.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-SRM-install-Step-1-vCenter.png']);"><img class="aligncenter size-full wp-image-1967" title="SRM install Step 1 - vCenter" src="http://assets.virtuallyhyper.com/2012-08-SRM-install-Step-1-vCenter.png" alt="SRM install Step 1 vCenter Installing SRM with custom certificates" width="505" height="380" /></a></p>
...
<p><a href="http://assets.virtuallyhyper.com/2012-08-SRM-install-Step-3-select-p12-certificate.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-SRM-install-Step-3-select-p12-certificate.png']);"><img class="aligncenter size-full wp-image-1968" title="SRM install Step 3 - select p12 certificate" src="http://assets.virtuallyhyper.com/2012-08-SRM-install-Step-3-select-p12-certificate.png" alt="SRM install Step 3 select p12 certificate Installing SRM with custom certificates" width="505" height="380" /></a></p>
...
<p><a href="http://assets.virtuallyhyper.com/2012-08-Failed-to-validate-certificate-Trusted-root.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-Failed-to-validate-certificate-Trusted-root.png']);"><img class="aligncenter size-full wp-image-1969" title="Failed to validate certificate - Trusted root" src="http://assets.virtuallyhyper.com/2012-08-Failed-to-validate-certificate-Trusted-root.png" alt="Failed to validate certificate Trusted root Installing SRM with custom certificates" width="411" height="178" /></a></p>
...
<p><a href="http://assets.virtuallyhyper.com/2012-08-Failed-to-validate-certificate-FQDN.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-Failed-to-validate-certificate-FQDN.png']);"><img class="aligncenter size-full wp-image-1970" title="Failed to validate certificate - FQDN" src="http://assets.virtuallyhyper.com/2012-08-Failed-to-validate-certificate-FQDN.png" alt="Failed to validate certificate FQDN Installing SRM with custom certificates" width="405" height="177" /></a></p>
