...
That looks good, then going to ****, I saw the following page: [munin-node.conf](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-02-munin-first-page.png) page we see this directive:
...
3.  Higher CPU Utilization
    *   Checking out **top**, I saw **munin-html** take 90% of the CPU, while *Collectd* is around 1%. Check it out: ![munin cpu usage g Monitor Different Systems with Munin](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-02-munin-cpu-usage_g.png)
    *   Lastly I don't know if you want to call this irony, but I checked *Collectd* graphs and here is what I saw: ![collectd cpu usage after munin Monitor Different Systems with Munin](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-02-collectd_cpu_usage_after_munin.png) At about 20:30 I installed *Munin* on the system, and right after that we see a spike in CPU usage every 5 minutes.
