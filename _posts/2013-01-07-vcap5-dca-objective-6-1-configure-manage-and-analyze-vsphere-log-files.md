...
![esxi DCUI VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-esxi_DCUI.png)

Scroll down to "View System Logs" and check you can select different logs to look at:

![view logs from dcui VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-view_logs_from_dcui.png)
...
![home view from host VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-home_view_from_host.png)

Then click on "System Log" and you will see the following:

![view logs from vsphere client VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-view_logs_from_vsphere_client.png)
...
![export system logs from vcenter VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-export_system_logs_from_vcenter.png)
...
![generate host and vc logs VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-generate_host_and_vc_logs.png)
...
>
> ![esxcli system syslog commands VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-esxcli_system_syslog_commands.png)
...
![syslog collector logs1 VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-syslog_collector_logs1.png)
...
![testing syslog collection VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-testing_syslog_collection.png)
...
![vcenter installer VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-vcenter_installer.png)

Select "VMware Syslog Collector" and click "Install":

![select syslog collector VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-select_syslog_collector.png)
...
![syslog collector configuration VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-syslog_collector_configuration.png)
...
![syslog collector installation type VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-syslog_collector_installation_type.png)

Then keep the default port settings:

![syslog collector port settings VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-syslog_collector_port_settings.png)

Then click Next and then Finish. After that you will see the service starts under "services.msc":

![syslog service started VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-syslog_service_started.png)
...
> ![vcenter install dump collector VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-vcenter_install_dump_collector.png)
...
![dump collector install size VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-dump_collector_install_size.png)
...
![dump collector install type VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-dump_collector_install_type.png)
...
![esxcli core dump VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-esxcli_core_dump.png)
...
![psod dump collector VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-psod_dump_collector.png)

![ls core dump VCAP5 DCA Objective 6.1 – Configure, Manage, and Analyze vSphere Log Files ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-ls_core_dump.png)
