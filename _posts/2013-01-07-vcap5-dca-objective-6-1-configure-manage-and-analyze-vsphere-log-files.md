...
author: karim
comments: true
date: 2013-01-07 14:05:45+00:00
layout: post
slug: vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files
...
[![esxi_DCUI](http://virtuallyhyper.com/wp-content/uploads/2012/12/esxi_DCUI.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/esxi_dcui/)

Scroll down to "View System Logs" and check you can select different logs to look at:

[![view_logs_from_dcui](http://virtuallyhyper.com/wp-content/uploads/2012/12/view_logs_from_dcui.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/view_logs_from_dcui/)
...
[![home_view_from_host](http://virtuallyhyper.com/wp-content/uploads/2012/12/home_view_from_host.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/home_view_from_host/)

Then click on "System Log" and you will see the following:

[![view_logs_from_vsphere_client](http://virtuallyhyper.com/wp-content/uploads/2012/12/view_logs_from_vsphere_client.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/view_logs_from_vsphere_client/)
...
[![export_system_logs_from_vcenter](http://virtuallyhyper.com/wp-content/uploads/2012/12/export_system_logs_from_vcenter.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/export_system_logs_from_vcenter/)
...
[![generate_host_and_vc_logs](http://virtuallyhyper.com/wp-content/uploads/2012/12/generate_host_and_vc_logs.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/generate_host_and_vc_logs/)
...
> The _esxcli system syslog_ command allows you to configure the logging behavior of your ESXi system. With vSphere 5.0, you can manage the top‐level logger and subloggers. The command has the following options.

[![esxcli_system_syslog_commands](http://virtuallyhyper.com/wp-content/uploads/2012/12/esxcli_system_syslog_commands.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/esxcli_system_syslog_commands/)
...
[![syslog_collector_logs](http://virtuallyhyper.com/wp-content/uploads/2012/12/syslog_collector_logs1.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/syslog_collector_logs-2/)
...
[![testing_syslog_collection](http://virtuallyhyper.com/wp-content/uploads/2012/12/testing_syslog_collection.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/testing_syslog_collection/)


### Analyze log entries to obtain configuration information


You can check _/var/log/syslog_ to see how we logged into an iSCSI array. You will see something like this:
...
[![vcenter_installer](http://virtuallyhyper.com/wp-content/uploads/2012/12/vcenter_installer.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/vcenter_installer/)

Select "VMware Syslog Collector" and click "Install":

[![select_syslog_collector](http://virtuallyhyper.com/wp-content/uploads/2012/12/select_syslog_collector.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/select_syslog_collector/)
...
[![syslog_collector_configuration](http://virtuallyhyper.com/wp-content/uploads/2012/12/syslog_collector_configuration.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/syslog_collector_configuration/)
...
[![syslog_collector_installation_type](http://virtuallyhyper.com/wp-content/uploads/2012/12/syslog_collector_installation_type.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/syslog_collector_installation_type/)

Then keep the default port settings:

[![syslog_collector_port_settings](http://virtuallyhyper.com/wp-content/uploads/2012/12/syslog_collector_port_settings.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/syslog_collector_port_settings/)

Then click Next and then Finish. After that you will see the service starts under "services.msc":

[![syslog_service_started](http://virtuallyhyper.com/wp-content/uploads/2012/12/syslog_service_started.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/syslog_service_started/)
...
> 
[![vcenter_install_dump_collector](http://virtuallyhyper.com/wp-content/uploads/2012/12/vcenter_install_dump_collector.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/vcenter_install_dump_collector/)
...
[![dump_collector_install_size](http://virtuallyhyper.com/wp-content/uploads/2012/12/dump_collector_install_size.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/dump_collector_install_size/)
...
[![dump_collector_install_type](http://virtuallyhyper.com/wp-content/uploads/2012/12/dump_collector_install_type.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/dump_collector_install_type/)
...
[![esxcli_core_dump](http://virtuallyhyper.com/wp-content/uploads/2012/12/esxcli_core_dump.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/esxcli_core_dump/)
...
[![psod_dump_collector](http://virtuallyhyper.com/wp-content/uploads/2012/12/psod_dump_collector.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/psod_dump_collector/)


[![ls_core_dump](http://virtuallyhyper.com/wp-content/uploads/2012/12/ls_core_dump.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-1-configure-manage-and-analyze-vsphere-log-files/ls_core_dump/)
