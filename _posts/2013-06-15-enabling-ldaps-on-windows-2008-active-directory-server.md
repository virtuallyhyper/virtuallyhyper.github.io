...
![dsa started Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-dsa_started.png)

Then right click in the white space and go to "New" -> "User":

![new user dsa g Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-new_user_dsa_g.png)

Then fill out the User information:

![new user filled out Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-new_user_filled_out.png)

Lastly set the user's password:

![set password Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-set_password.png)

After it's all said and done you will see the following in the "Active Directory Users and Computers" Console:

![user added dsa Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-user_added_dsa.png)
...
![ldp exe started Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-ldp_exe_started.png)
...
![ldp exe bind button g Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-ldp_exe_bind_button_g.png)

and let's leave the defaults:

![bind dialogue Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-bind_dialogue.png)

After clicking OK, you will see the connection go through and the *bind* to the AD server succeed:

![ldp exe bound Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-ldp_exe_bound.png)

Now let's start browsing the AD server, first let's select the "Tree" view:

![ldp exe tree button g Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-ldp_exe_tree_button_g.png)
...
![tree view base dn Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-tree_view_base_dn.png)

I just want to see all the available branches/children that are part of the AD server:

![children AD server Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-children_AD_server.png)

Expanding the **User** branch and locating our test user "elatov", we see the following:

![elatov user info ldp exe Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-elatov_user_info_ldp_exe.png)
...
![gnomint props cert Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-gnomint_props_cert.png)

Then click on the "Details" tab, expand the "Extensions", and lastly expand the "Extended Key Usage" section:

![cert props gnomint Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-cert-props-gnomint.png)
...
![mmc started Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-mmc_started.png)

#### 2.Click **File**, click **Add/Remove Snap-in**, select **Certificates** from the available snap-ins, and then click **Add**:

![cert snap int Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-cert-snap-int.png)
...
![serv acct cert snapin Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-serv_acct_cert_snapin.png)

#### 4. In **Add or Remove Snap-ins**, click **Local computer**, and then click **Next**.

![loc comp cert snapin Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-loc_comp_cert_snapin.png)

#### 5. In **Add or Remove Snap-ins**, click **Active Directory Domain Services**, click **Finish**, and then click **OK**:

![ad ds cert snapin Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-ad-ds-cert-snapin.png)
...
![ntds cert snapin Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-ntds-cert-snapin.png)

#### 7. To import a certificate, right-click the **NTDS\Personal folder**, click **All Tasks**, and then click **Import**:

![cert snapin import cert Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-cert_snapin-import_cert.png)

![import cert Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-import-cert.png)

![include extended props import cert Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-include_extended_props_import_cert.png)

After the certificate is imported you will see the following in the Snap-In:

![ldaps cert imported Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-ldaps_cert_imported.png)
...
![trusted root ca certs self signed Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-trusted_root_ca_certs_self_signed.png)
...
![ldp exe ssl Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-ldp_exe_ssl.png)

Then click OK and make sure the connection is successful:

![successful ldp exe ssl Enabling LDAPS on Windows 2008 Active Directory Server](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-successful_ldp_exe_ssl.png)
