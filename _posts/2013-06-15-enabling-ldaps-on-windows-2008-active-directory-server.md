...
author: karim
comments: true
date: 2013-06-15 11:17:10+00:00
layout: post
slug: enabling-ldaps-on-windows-2008-active-directory-server
...
## Running an _ldapsearch_ against a Windows AD Server
...
[![dsa_started](http://virtuallyhyper.com/wp-content/uploads/2013/05/dsa_started.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/dsa_started.png)
...
[![new_user_dsa_g](http://virtuallyhyper.com/wp-content/uploads/2013/05/new_user_dsa_g.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/new_user_dsa_g.png)
...
[![new_user_filled_out](http://virtuallyhyper.com/wp-content/uploads/2013/05/new_user_filled_out.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/new_user_filled_out.png)
...
[![set_password](http://virtuallyhyper.com/wp-content/uploads/2013/05/set_password.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/set_password.png)
...
[![user_added_dsa](http://virtuallyhyper.com/wp-content/uploads/2013/05/user_added_dsa.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/user_added_dsa.png)
...
### Use _ldp.exe_ to browse the AD Server
...
[![ldp_exe_started](http://virtuallyhyper.com/wp-content/uploads/2013/05/ldp_exe_started.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/ldp_exe_started.png)





Now let's _bind_ to the AD server, since we are local to the AD server we can just bind with the same user that we are currently logged in:





[![ldp_exe_bind_button_g](http://virtuallyhyper.com/wp-content/uploads/2013/05/ldp_exe_bind_button_g.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/ldp_exe_bind_button_g.png)
...
[![bind_dialogue](http://virtuallyhyper.com/wp-content/uploads/2013/05/bind_dialogue.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/bind_dialogue.png)





After clicking OK, you will see the connection go through and the _bind_ to the AD server succeed:





[![ldp_exe_bound](http://virtuallyhyper.com/wp-content/uploads/2013/05/ldp_exe_bound.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/ldp_exe_bound.png)
...
[![ldp_exe_tree_button_g](http://virtuallyhyper.com/wp-content/uploads/2013/05/ldp_exe_tree_button_g.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/ldp_exe_tree_button_g.png)
...
[![tree_view_base_dn](http://virtuallyhyper.com/wp-content/uploads/2013/05/tree_view_base_dn.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/tree_view_base_dn.png)
...
[![children_AD_server](http://virtuallyhyper.com/wp-content/uploads/2013/05/children_AD_server.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/children_AD_server.png)
...
[![elatov_user_info_ldp_exe](http://virtuallyhyper.com/wp-content/uploads/2013/05/elatov_user_info_ldp_exe.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/elatov_user_info_ldp_exe.png)
...
### Use _dsquery_ to find DNs of Users
...
### Use _openldap_ Tools to perform an LDAP Query
...
We can see that I used "CN=Users,DC=elatov,DC=local" as my **baseDN** and I used the account "administrator@elatov.local" to **bind** to the AD server. I could also use the _elatov_ account to bind with, for example:
...
### Use _mozldap_ Tools to perform an LDAP Query
...
I had recently created my own certificate with my own CA. Check out "[Setup Your Own Certificate Authority (CA) on Linux and Use it in a Windows Environment](http://virtuallyhyper.com/2013/04/setup-your-own-certificate-authority-ca-on-linux-and-use-it-in-a-windows-environment/)" for more information. I wanted to make sure the certificate I had created had the appropriate OID enabled. From the [certificate_properties.c](http://gnomint.sourcearchive.com/documentation/0.9.1/certificate__properties_8c-source.html) source file here are the different OIDs defined:
...
[![gnomint_props_cert](http://virtuallyhyper.com/wp-content/uploads/2013/05/gnomint_props_cert.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/gnomint_props_cert.png)
...
[![cert-props-gnomint](http://virtuallyhyper.com/wp-content/uploads/2013/05/cert-props-gnomint.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/cert-props-gnomint.png)
...
[![mmc_started](http://virtuallyhyper.com/wp-content/uploads/2013/05/mmc_started.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/mmc_started.png)
...
[![cert-snap-int](http://virtuallyhyper.com/wp-content/uploads/2013/05/cert-snap-int.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/cert-snap-int.png)
...
[![serv_acct_cert_snapin](http://virtuallyhyper.com/wp-content/uploads/2013/05/serv_acct_cert_snapin.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/serv_acct_cert_snapin.png)
...
[![loc_comp_cert_snapin](http://virtuallyhyper.com/wp-content/uploads/2013/05/loc_comp_cert_snapin.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/loc_comp_cert_snapin.png)
...
[![ad-ds-cert-snapin](http://virtuallyhyper.com/wp-content/uploads/2013/05/ad-ds-cert-snapin.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/ad-ds-cert-snapin.png)
...
[![ntds-cert-snapin](http://virtuallyhyper.com/wp-content/uploads/2013/05/ntds-cert-snapin.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/ntds-cert-snapin.png)
...
[![cert_snapin-import_cert](http://virtuallyhyper.com/wp-content/uploads/2013/05/cert_snapin-import_cert.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/cert_snapin-import_cert.png)





[![import-cert](http://virtuallyhyper.com/wp-content/uploads/2013/05/import-cert.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/import-cert.png)





[![include_extended_props_import_cert](http://virtuallyhyper.com/wp-content/uploads/2013/05/include_extended_props_import_cert.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/include_extended_props_import_cert.png)
...
[![ldaps_cert_imported](http://virtuallyhyper.com/wp-content/uploads/2013/05/ldaps_cert_imported.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/ldaps_cert_imported.png)
...
[![trusted_root_ca_certs_self_signed](http://virtuallyhyper.com/wp-content/uploads/2013/05/trusted_root_ca_certs_self_signed.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/trusted_root_ca_certs_self_signed.png)
...
[![ldp_exe_ssl](http://virtuallyhyper.com/wp-content/uploads/2013/05/ldp_exe_ssl.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/ldp_exe_ssl.png)
...
[![successful_ldp_exe_ssl](http://virtuallyhyper.com/wp-content/uploads/2013/05/successful_ldp_exe_ssl.png)](http://virtuallyhyper.com/wp-content/uploads/2013/05/successful_ldp_exe_ssl.png)
