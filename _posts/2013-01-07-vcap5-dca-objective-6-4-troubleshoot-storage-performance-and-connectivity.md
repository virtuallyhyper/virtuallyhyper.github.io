...
author: karim
comments: true
date: 2013-01-07 14:08:12+00:00
layout: post
slug: vcap5-dca-objective-6-4-troubleshoot-storage-performance-and-connectivity
...
This was covered in "[VCAP5-DCA Objective 1.3](http://virtuallyhyper.com/2012/10/vcap5-dca-objective-1-3-configure-and-manage-complex-multipathing-and-psa-plug-ins/)" and in "[VCAP5-DCA Objective 1.1](http://virtuallyhyper.com/2012/10/vcap5-dca-objective-1-1-implement-and-manage-complex-storage-solutions/)"
...
>   * Run _esxcli iscsi adapter param get_ to list parameter options for the iSCSI adapter.
> 
	
>   * Run _esxcli iscsi adapter discovery sendtarget param get_ or _esxcli iscsi adapter target __portal param set_ to retrieve information about iSCSI parameters and whether they are settable.
> 
	
>   * Run _esxcli iscsi adapter discovery sendtarget param get_ or _esxcli iscsi adapter target portal param set_ to set iSCSI parameter options.
> 
...
[![iscsi_parameters](http://virtuallyhyper.com/wp-content/uploads/2012/12/iscsi_parameters.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-4-troubleshoot-storage-performance-and-connectivity/iscsi_parameters/)
...
[![nfs_access_error](http://virtuallyhyper.com/wp-content/uploads/2012/12/nfs_access_error.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-4-troubleshoot-storage-performance-and-connectivity/nfs_access_error/)
...
[![common_nfs_issues](http://virtuallyhyper.com/wp-content/uploads/2012/12/common_nfs_issues.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-4-troubleshoot-storage-performance-and-connectivity/common_nfs_issues/)
...
[![esxtop_thresholds_for_disk](http://virtuallyhyper.com/wp-content/uploads/2012/12/esxtop_thresholds_for_disk.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-4-troubleshoot-storage-performance-and-connectivity/esxtop_thresholds_for_disk/)
...
[![storage_performance_troubleshooting](http://virtuallyhyper.com/wp-content/uploads/2012/12/storage_performance_troubleshooting.png)](http://virtuallyhyper.com/2013/01/vcap5-dca-objective-6-4-troubleshoot-storage-performance-and-connectivity/storage_performance_troubleshooting/)
