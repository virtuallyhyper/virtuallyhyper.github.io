...
![storage_protocols](http://assets.virtuallyhyper.com/2012-09-storage_protocols.png)
...
![storage_view_vms](http://assets.virtuallyhyper.com/2012-09-storage_view_vms.png)
...
![datastore_maps](http://assets.virtuallyhyper.com/2012-09-datastore_maps.png)
...
![datastore_alarms](http://assets.virtuallyhyper.com/2012-09-datastore_alarms.png)

You can also check out storage metrics by going to the performance tab. It will look something like this:

![performance_tab_datastore](http://assets.virtuallyhyper.com/2012-09-performance_tab_datastore.png)
...
![host_disk_performance](http://assets.virtuallyhyper.com/2012-09-host_disk_performance.png)
...
![create_new_alarm](http://assets.virtuallyhyper.com/2012-09-create_new_alarm.png)
...
![select_trigger_for_alarm](http://assets.virtuallyhyper.com/2012-09-select_trigger_for_alarm.png)
...
![right_click_datastore_view](http://assets.virtuallyhyper.com/2012-09-right_click_datastore_view.png)

Fill Out the Name:

![Name_Storage_DRS_Cluster](http://assets.virtuallyhyper.com/2012-09-Name_Storage_DRS_Cluster.png)

Set the Automation Level:

![SDRS_Automation_level](http://assets.virtuallyhyper.com/2012-09-SDRS_Automation_level.png)

Set the Threshold Limits:

![SDRS_Threshold_limits](http://assets.virtuallyhyper.com/2012-09-SDRS_Threshold_limits.png)

Select Cluster to enable Storage DRS on:

![SDRS_Select_Hosts](http://assets.virtuallyhyper.com/2012-09-SDRS_Select_Hosts.png)

Select Datastores to participate in the Storage DRS Cluster:

![SDRS_Select_Datastore](http://assets.virtuallyhyper.com/2012-09-SDRS_Select_Datastore.png)

Click Finish on the Summary Page:

![SDRS_Summary_page](http://assets.virtuallyhyper.com/2012-09-SDRS_Summary_page.png)

You will see the datastore cluster that you created, like so:

![datastore_cluster_view_with_dscl](http://assets.virtuallyhyper.com/2012-09-datastore_cluster_view_with_dscl.png)
...
![enable_datastore_cluster](http://assets.virtuallyhyper.com/2012-09-enable_datastore_cluster.png)
