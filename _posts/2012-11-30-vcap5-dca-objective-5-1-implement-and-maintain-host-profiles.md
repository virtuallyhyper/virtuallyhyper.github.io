...
![host_profile_view](http://assets.virtuallyhyper.com/2012-11-host_profile_view.png)
...
![create_hp_step1](http://assets.virtuallyhyper.com/2012-11-create_hp_step1.png)

then select a host from which you want to create a profile from:

![create_hp_step2](http://assets.virtuallyhyper.com/2012-11-create_hp_step2.png)

Then name your host profile:

![create_hp_step3](http://assets.virtuallyhyper.com/2012-11-create_hp_step3.png)

After that click "Finish" and then you will have a profile under the Host Profile view, like so:

![create_hp](http://assets.virtuallyhyper.com/2012-11-create_hp.png)
...
![edit_host_profile](http://assets.virtuallyhyper.com/2012-11-edit_host_profile.png)
...
>
> ![hp_subprofiles](http://assets.virtuallyhyper.com/2012-11-hp_subprofiles.png)
...
![hp-storage_conf](http://assets.virtuallyhyper.com/2012-11-hp-storage_conf.png)
...
![answer file options VCAP5 DCA Objective 5.1 – Implement and Maintain Host Profiles](http://assets.virtuallyhyper.com/2012-11-answer_file_options.png)

Also here is how editing the answer file looks like, by selecting "Update Answer File", from vCenter:

![update answer files VCAP5 DCA Objective 5.1 – Implement and Maintain Host Profiles](http://assets.virtuallyhyper.com/2012-11-update_answer_files.png)
