...
author: karim
comments: true
date: 2012-03-20 05:08:38+00:00
layout: post
slug: increase-lvm-partition-size-on-a-linux-vm
...
That is what we wanted to see. By the way, resize2fs works on ext3 online only ([resize2fs(8) - Linux man page](http://linux.die.net/man/8/resize2fs)). Other OSes provide ext2online ([ext2online(8) - Linux man page](http://linux.die.net/man/8/ext2online)). Like I mentioned, this was probably not the safest way of doing this, so let's go ahead and reboot the OS and force a filesystem check, just to be safe:
