...
![SkyDrive Comparison Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-SkyDrive_Comparison.png)
...
![skydrive logged in Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-skydrive-logged-in.png)
...
![Live connect dev center Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-Live_connect_dev_center.png)

Click on "**My Apps**" and then click on "**Create Application**":

![Live dev center my apps Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-Live_dev_center_my_apps.png)
...
![skydrive Api rgistered i Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-skydrive_Api_rgistered_i.png)
...
![dropbox installer Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-dropbox_installer.png)

After the install is done, you will see the dropbox status in your notification area:

![dropbox notificateion Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-dropbox_notificateion.png)
...
![sme cloud list Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-sme_cloud_list.png)
...
![sme explorer Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-sme_explorer.png)

After your are authenticated, you can add a storage provider. For example I added **box.net**:

![sme add cloud provider Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-sme_add_cloud_provider.png)
...
![sme sync center 5min Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-sme-sync-center-5min.png)
...
![link folder sme Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-link_folder-sme.png)
...
![smeclient 1 Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-smeclient_1.png)
...
![ubone setup Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-ubone_setup.png)

After that click on "**Sign me in with my existing account**" and it will ask you to authenticate:

![ubon auth Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-ubon_auth.png)

After you are authenticated it will show you which folder it will sync with and the one we have set it perfect:

![ub one sync Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-ub_one_sync.png)
...
![seafile repo url Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-seafile_repo_url.png)
...
![seafile applet Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-seafile_applet.png)
...
![seafile client browser Syncing Files with Various Cloud Storage Solutions](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-10-seafile_client_browser.png)
