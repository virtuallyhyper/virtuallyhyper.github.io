...
author: karim
comments: true
date: 2013-10-18 21:18:33+00:00
layout: post
slug: syncing-files-various-cloud-storage-solutions
...
I haven't used **skydrive** before, so I wanted to give it a try. First, what is _skydrive_? from wikipedia:
...
[![SkyDrive_Comparison](http://virtuallyhyper.com/wp-content/uploads/2013/10/SkyDrive_Comparison.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/SkyDrive_Comparison.png)
...
[![skydrive-logged-in](http://virtuallyhyper.com/wp-content/uploads/2013/10/skydrive-logged-in.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/skydrive-logged-in.png)
...
[![Live_connect_dev_center](http://virtuallyhyper.com/wp-content/uploads/2013/10/Live_connect_dev_center.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/Live_connect_dev_center.png)
...
[![Live_dev_center_my_apps](http://virtuallyhyper.com/wp-content/uploads/2013/10/Live_dev_center_my_apps.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/Live_dev_center_my_apps.png)





After clicking "**Create Application**" you can call it whatever you want. Then after clicking **Next** it will show your _client ID_ and the _client secret_:





[![skydrive_Api_rgistered_i](http://virtuallyhyper.com/wp-content/uploads/2013/10/skydrive_Api_rgistered_i.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/skydrive_Api_rgistered_i.png)





Make sure to set **Mobile Client App** to **yes** and then click **Save**. Add both the _Client ID_ and _Secret_ to your **.lcrc** file:
...
The application supported _python2.7_, so let's install **pip** for that:
...
[![dropbox_installer](http://virtuallyhyper.com/wp-content/uploads/2013/10/dropbox_installer.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/dropbox_installer.png)
...
[![dropbox_notificateion](http://virtuallyhyper.com/wp-content/uploads/2013/10/dropbox_notificateion.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/dropbox_notificateion.png)
...
But they were just CLIs that depended on **dropboxd** to be already running (which was only provided for x86 and x86_64 architectures). There is a _nautilus-plugin_, which can be compiled (the source can be found [here](https://www.dropbox.com/help/247/en)), but same thing, it depends on **dropboxd**. There is forum about the lack of support for the ARM architecture [here](http://www.raspberrypi.org/phpBB3/viewtopic.php?f=63&t=7391).
...
Everyone knows the popular alternative to _DropBox_ is _Box_. The install on my Mac was similar to the DropBox install. You just launch the installer and it took care of the rest. The cool thing with Box is that you can access your files via **WebDav**. I ran into some pages that utilized WebDav with Box:
...
**Note:** I added the _users_ parameter to the **fstab** entry, this will allow regular users to un-mount that volume as well.
...
[![sme_cloud_list](http://virtuallyhyper.com/wp-content/uploads/2013/10/sme_cloud_list.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/sme_cloud_list.png)
...
[![sme_explorer](http://virtuallyhyper.com/wp-content/uploads/2013/10/sme_explorer.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/sme_explorer.png)
...
[![sme_add_cloud_provider](http://virtuallyhyper.com/wp-content/uploads/2013/10/sme_add_cloud_provider.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/sme_add_cloud_provider.png)
...
[![sme-sync-center-5min](http://virtuallyhyper.com/wp-content/uploads/2013/10/sme-sync-center-5min.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/sme-sync-center-5min.png)
...
[![link_folder-sme](http://virtuallyhyper.com/wp-content/uploads/2013/10/link_folder-sme.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/link_folder-sme.png)
...
[![smeclient_1](http://virtuallyhyper.com/wp-content/uploads/2013/10/smeclient_1.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/smeclient_1.png)
...
So the only thing you could do is mount like you did with **davfs** and _box_, but the SME Sync Center couldn't be launched without Xorg running. I really liked the product (the idea is fantastic, if I ever want to tranfer between storage cloud solutions, I will definitely use this), but the lack of the CLI pushed me back.
...
[![ubone_setup](http://virtuallyhyper.com/wp-content/uploads/2013/10/ubone_setup.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/ubone_setup.png)
...
[![ubon_auth](http://virtuallyhyper.com/wp-content/uploads/2013/10/ubon_auth.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/ubon_auth.png)
...
[![ub_one_sync](http://virtuallyhyper.com/wp-content/uploads/2013/10/ub_one_sync.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/ub_one_sync.png)
...
[![seafile_repo_url](http://virtuallyhyper.com/wp-content/uploads/2013/10/seafile_repo_url.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/seafile_repo_url.png)
...
[![seafile_applet](http://virtuallyhyper.com/wp-content/uploads/2013/10/seafile_applet.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/seafile_applet.png)
...
[![seafile_client_browser](http://virtuallyhyper.com/wp-content/uploads/2013/10/seafile_client_browser.png)](http://virtuallyhyper.com/wp-content/uploads/2013/10/seafile_client_browser.png)
