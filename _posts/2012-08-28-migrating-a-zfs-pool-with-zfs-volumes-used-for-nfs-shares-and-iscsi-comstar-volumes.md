...
author: karim
comments: true
date: 2012-08-28 23:00:43+00:00
layout: post
slug: migrating-a-zfs-pool-with-zfs-volumes-used-for-nfs-shares-and-iscsi-comstar-volumes
title: Migrating a ZFS Pool with ZFS Volumes Used for NFS Shares and iSCSI Comstar
  Volumes
wordpress_id: 2642
categories:
- Home Lab
...
When working with Comstar iSCSI there are usually two services in play. The first one is _stmf_, more information can be found in the Oracle Documentation "[Configuring iSCSI Devices With COMSTAR](http://docs.oracle.com/cd/E23824_01/html/821-1459/fnnop.html)", from that documentation:
...
The second aspect of the COMSTAR Framework is the 'iscsi-target', this used to be handled by the _iscsitadm_, from the Oracle Document "[COMSTAR Replaces iSCSI Target Daemon](http://docs.oracle.com/cd/E23824_01/html/E24456/storage-7.html)":
