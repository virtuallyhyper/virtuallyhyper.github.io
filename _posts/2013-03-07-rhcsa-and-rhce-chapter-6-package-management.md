...
>
>
> When invoked this way, **rpmbuild** will read the .spec file and go through in order the stages listed below. Names beginning with % are predefined macros (see the next table down). ![rpmbuild stages RHCSA and RHCE Chapter 6 Package Management](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-02-rpmbuild_stages.png)
> As you can tell, certain directories have certain purposes in **rpmbuild**. These are:
>
> ![RHCSA and RHCE Chapter 6 Package Management](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-02-rpmbuild_directories.png)
