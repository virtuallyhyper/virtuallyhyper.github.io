...
<p><a href="http://assets.virtuallyhyper.com/2012-08-vCenter-Managed-Ip-address.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-vCenter-Managed-Ip-address.png']);"><img class="aligncenter size-full wp-image-1990" title="vCenter Managed Ip address" src="http://assets.virtuallyhyper.com/2012-08-vCenter-Managed-Ip-address.png" alt="vCenter Managed Ip address Using Custom Root CA Certificates with VMware SRM 5.x vSphere Replication" width="660" height="643" /></a></p>
<p>Now you can open up the SRM plug-in and click on vSphere replication on the bottom left of the page.</p>
<p><a href="http://assets.virtuallyhyper.com/2012-08-SRM-select-vSphere-Replication.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-SRM-select-vSphere-Replication.png']);"><img class="aligncenter size-full wp-image-1991" title="SRM select vSphere Replication" src="http://assets.virtuallyhyper.com/2012-08-SRM-select-vSphere-Replication.png" alt="SRM select vSphere Replication Using Custom Root CA Certificates with VMware SRM 5.x vSphere Replication" width="292" height="123" /></a></p>
...
<p><a href="http://assets.virtuallyhyper.com/2012-08-Deploy-VRMS.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-Deploy-VRMS.png']);"><img class="aligncenter size-full wp-image-1992" title="Deploy VRMS" src="http://assets.virtuallyhyper.com/2012-08-Deploy-VRMS.png" alt="Deploy VRMS Using Custom Root CA Certificates with VMware SRM 5.x vSphere Replication" width="385" height="174" /></a></p>
...
<p><a href="http://assets.virtuallyhyper.com/2012-08-Configure-VRMS.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-Configure-VRMS.png']);"><img class="aligncenter size-full wp-image-1995" title="Configure VRMS" src="http://assets.virtuallyhyper.com/2012-08-Configure-VRMS.png" alt="Configure VRMS Using Custom Root CA Certificates with VMware SRM 5.x vSphere Replication" width="398" height="277" /></a></p>
...
<p><a href="http://assets.virtuallyhyper.com/2012-08-VRMS-upload-certificate.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-VRMS-upload-certificate.png']);"><img class="aligncenter size-full wp-image-1997" title="VRMS upload certificate" src="http://assets.virtuallyhyper.com/2012-08-VRMS-upload-certificate.png" alt="VRMS upload certificate Using Custom Root CA Certificates with VMware SRM 5.x vSphere Replication" width="570" height="214" /></a></p>
...
<p><a href="http://assets.virtuallyhyper.com/2012-08-VRMS-VRM-Host-name.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-VRMS-VRM-Host-name.png']);"><img class="aligncenter size-full wp-image-1998" title="VRMS VRM Host name" src="http://assets.virtuallyhyper.com/2012-08-VRMS-VRM-Host-name.png" alt="VRMS VRM Host name Using Custom Root CA Certificates with VMware SRM 5.x vSphere Replication" width="554" height="44" /></a></p>
...
<p><a href="http://assets.virtuallyhyper.com/2012-08-VRMS-vCenter-Server-Address.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-VRMS-vCenter-Server-Address.png']);"><img class="aligncenter size-full wp-image-1996" title="VRMS vCenter Server Address" src="http://assets.virtuallyhyper.com/2012-08-VRMS-vCenter-Server-Address.png" alt="VRMS vCenter Server Address Using Custom Root CA Certificates with VMware SRM 5.x vSphere Replication" width="572" height="62" /></a></p>
...
<a href="http://assets.virtuallyhyper.com/2012-08-SRM-VRMS-pairing.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-SRM-VRMS-pairing.png']);"><img class="aligncenter size-full wp-image-2004" title="SRM VRMS pairing" src="http://assets.virtuallyhyper.com/2012-08-SRM-VRMS-pairing.png" alt="SRM VRMS pairing Using Custom Root CA Certificates with VMware SRM 5.x vSphere Replication" width="392" height="266" /></a></p>
...
<p><a href="http://assets.virtuallyhyper.com/2012-08-VRS-Deploy1.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-VRS-Deploy1.png']);"><img class="aligncenter size-full wp-image-2006" title="VRS Deploy" src="http://assets.virtuallyhyper.com/2012-08-VRS-Deploy1.png" alt="VRS Deploy1 Using Custom Root CA Certificates with VMware SRM 5.x vSphere Replication" width="383" height="184" /></a></p>
...
<p><a href="http://assets.virtuallyhyper.com/2012-08-VRS-Certificate-upload.png" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://assets.virtuallyhyper.com/2012-08-VRS-Certificate-upload.png']);"><img class="aligncenter size-full wp-image-2013" title="VRS Certificate upload" src="http://assets.virtuallyhyper.com/2012-08-VRS-Certificate-upload.png" alt="VRS Certificate upload Using Custom Root CA Certificates with VMware SRM 5.x vSphere Replication" width="272" height="186" /></a></p>
...
<p class="wp-flattr-button"><a class="FlattrButton" style="display:none;" href="http://virtuallyhyper.com/2012/08/using-a-custom-ca-with-vsphere-replication/" title=" Using Custom Root CA Certificates with VMware SRM 5.x vSphere Replication" rev="flattr;uid:virtuallyhyper;language:en_GB;category:text;tags:CA,Certifications,cli,command line,openssl,srm,VRMS,VRS,vSphere Replication,blog;button:compact;">A friend of mine recently pointed out this blog post when talking about SRM with custom certificates. Oddly enough, I had a similar customer where we hacked away at the...</a></p>