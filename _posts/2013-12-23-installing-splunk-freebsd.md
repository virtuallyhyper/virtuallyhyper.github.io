...
![splunk hw capacity Installing Splunk on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-11-splunk-hw-capacity.png)
...
![freebsd download Installing Splunk on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-11-freebsd_download.png)
...
![splunk data inputs Installing Splunk on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-11-splunk-data-inputs.png)

Then click on **UDP** and fill out all the settings:

![514 data input Installing Splunk on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-11-514-data-input.png)
...
On the WRT router, you can go to the **Services** Tab and configure it to send logs to a remote syslog server : ![wrt syslog Installing Splunk on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-11-wrt-syslog.png)

On OpenELEC, you can go to the OpenELEC settings and under **Services** you can specify a remote syslog server:

![openelec remote syslog Installing Splunk on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-11-openelec-remote-syslog.png)

After I was done with the configurations, here are all the hosts seen in splunk (under **Search** -> **Data Summary**):

![data summary g Installing Splunk on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-11-data-summary_g.png)
...
![license usage splunk g Installing Splunk on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-11-license-usage-splunk_g.png)
...
![system license g Installing Splunk on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-11-system-license_g.png)
...
![splunk license group Installing Splunk on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-11-splunk-license-group.png)
...
![splunk free version welcome screen Installing Splunk on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-11-splunk-free-version-welcome-screen.png)
...
![splunk url changed g Installing Splunk on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-11-splunk-url-changed_g.png)
