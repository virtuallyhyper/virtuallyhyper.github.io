...
![esxtop network problems VCAP5 DCA Objective 6.3 – Troubleshoot Network Performance and Connectivity ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-esxtop_network_problems.png)
...
![create port mirror VCAP5 DCA Objective 6.3 – Troubleshoot Network Performance and Connectivity ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-create_port_mirror.png)
...
![choose port from dvs VCAP5 DCA Objective 6.3 – Troubleshoot Network Performance and Connectivity ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-choose_port_from_dvs.png)

Then in the Create Mirror Session Wizard use that port number, like so:

![mirror session select port VCAP5 DCA Objective 6.3 – Troubleshoot Network Performance and Connectivity ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-mirror_session_select_port.png)
...
>     ![mirror session source type VCAP5 DCA Objective 6.3 – Troubleshoot Network Performance and Connectivity ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-mirror_session_source_type.png)
...
![mirror session select destination port VCAP5 DCA Objective 6.3 – Troubleshoot Network Performance and Connectivity ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-mirror_session_select_destination_port.png)
...
![mirror session verify settings VCAP5 DCA Objective 6.3 – Troubleshoot Network Performance and Connectivity ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-mirror_session_verify_settings.png)
...
![mirror session check settings VCAP5 DCA Objective 6.3 – Troubleshoot Network Performance and Connectivity ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-mirror_session_check_settings.png)
...
![dcui ip config VCAP5 DCA Objective 6.3 – Troubleshoot Network Performance and Connectivity ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-dcui_ip_config.png)
...
![dcui dns settings VCAP5 DCA Objective 6.3 – Troubleshoot Network Performance and Connectivity ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-dcui_dns_settings.png)
...
![test mgmt network dcui VCAP5 DCA Objective 6.3 – Troubleshoot Network Performance and Connectivity ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-test_mgmt_network_dcui.png)

And here is how the results look like:

![dcui test mgmt net results VCAP5 DCA Objective 6.3 – Troubleshoot Network Performance and Connectivity ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-dcui_test_mgmt_net_results.png)
...
![restart mgmt agents success VCAP5 DCA Objective 6.3 – Troubleshoot Network Performance and Connectivity ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-restart_mgmt_agents_success.png)
...
>
>     ![dcui options VCAP5 DCA Objective 6.3 – Troubleshoot Network Performance and Connectivity ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-dcui_options.png)
>
