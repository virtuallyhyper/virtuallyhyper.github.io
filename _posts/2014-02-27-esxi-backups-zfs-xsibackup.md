...
author: karim
comments: true
date: 2014-02-27 18:03:16+00:00
layout: post
slug: esxi-backups-zfs-xsibackup
...
The _data_ pool had a ComStar ZVol presented to an ESXi host and another ZFS Volume used for ISOs shared over NFS:
...
While the _other_ zpool wasn't used for anything but was the same size. I decided to use the _other_ zpool for backups.
...
I found a couple of sites that had instructions on how to copy ZFS Volumes across Zpools:
  ...
  * [Moving ZFS filesystems between pools](http://www.hlynes.com/2007/07/09/moving-zfs-filesystems-between-pools/)
...
There is a great description at [Reservation & Ref Reservation - An Explanation (Attempt)](http://nex7.blogspot.com/2013/03/reservation-ref-reservation-explanation.html) which helped me understand why all that space was utilized. [From Setting ZFS Quotas and Reservations](http://docs.oracle.com/cd/E19253-01/819-5461/gazvb/index.html):
...
> 
> If _refreservation_ is set, a snapshot is only allowed if sufficient unreserved pool space exists outside of this reservation to accommodate the current number of referenced bytes in the dataset.
> 
> 
...
If you want you can use [Napp-It](http://www.napp-it.org/index_en.html) (if you are using an OpenSolaris Distribution) to present the backup LUN to ESXi (I described the process [here](http://virtuallyhyper.com/2014/01/zfs-iscsi-benchmarks-tests/)). This time around I decided to go command line. Here is the process I followed:
...
[![xsi-report-2](http://virtuallyhyper.com/wp-content/uploads/2014/02/xsi-report-2.png)](http://virtuallyhyper.com/wp-content/uploads/2014/02/xsi-report-2.png)
...
[![esxtop-during-backup2_g](http://virtuallyhyper.com/wp-content/uploads/2014/02/esxtop-during-backup2_g-1024x96.png)](http://virtuallyhyper.com/wp-content/uploads/2014/02/esxtop-during-backup2_g.png)
