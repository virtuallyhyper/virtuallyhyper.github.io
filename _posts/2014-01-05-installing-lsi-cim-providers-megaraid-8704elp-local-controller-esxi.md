...
![cim sensors esxi Installing LSI CIM Providers for MegaRaid 8704ELP Local Controller on ESXi 5.0](http://assets.virtuallyhyper.com/2014-01-cim-sensors-esxi.png)
...
![lsi mgmt tools Installing LSI CIM Providers for MegaRaid 8704ELP Local Controller on ESXi 5.0](http://assets.virtuallyhyper.com/2014-01-lsi-mgmt-tools.png)
...
![lsi seen sensors Installing LSI CIM Providers for MegaRaid 8704ELP Local Controller on ESXi 5.0](http://assets.virtuallyhyper.com/2014-01-lsi-seen-sensors.png)
...
![cim health status lsi 24 Installing LSI CIM Providers for MegaRaid 8704ELP Local Controller on ESXi 5.0](http://assets.virtuallyhyper.com/2014-01-cim-health-status-lsi-24.png)
...
![health status lsi 30 Installing LSI CIM Providers for MegaRaid 8704ELP Local Controller on ESXi 5.0](http://assets.virtuallyhyper.com/2014-01-health-status-lsi-30.png)
...
![veeam hw monitor Installing LSI CIM Providers for MegaRaid 8704ELP Local Controller on ESXi 5.0](http://assets.virtuallyhyper.com/2014-01-veeam-hw-monitor.png)
...
![offlined disk cim Installing LSI CIM Providers for MegaRaid 8704ELP Local Controller on ESXi 5.0](http://assets.virtuallyhyper.com/2014-01-offlined-disk-cim.png)

And checking out *Veeam One*, an alarm was fired for that:

![veeam on hardware alarm Installing LSI CIM Providers for MegaRaid 8704ELP Local Controller on ESXi 5.0](http://assets.virtuallyhyper.com/2014-01-veeam-on-hardware-alarm.png)
...
![veeam alarms back Installing LSI CIM Providers for MegaRaid 8704ELP Local Controller on ESXi 5.0](http://assets.virtuallyhyper.com/2014-01-veeam-alarms-back.png)
...
We can see that last event code is **0x00f9**, from the above MegaCLI events, we can see that corresponds to *VirtualDisk is Optimal*. BTW a full list of *megasas* events can be seen in [this PDF](http://assets.virtuallyhyper.com/2014-01-A_Event_Info.pdf).
