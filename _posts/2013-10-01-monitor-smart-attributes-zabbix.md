...
I really didn't change much, but just for reference [here](http://assets.virtuallyhyper.com/2013-09-zabbix-agentd.sh) is the script. Lastly to make sure it starts automatically on boot up, add it to the **/etc/init.d/rcS** file:
...
![zabbix trigger prototype Monitor SMART Attributes with Zabbix](http://assets.virtuallyhyper.com/2013-09-zabbix_trigger_prototype.png)
...
![zabbix pogo hd temp Monitor SMART Attributes with Zabbix](http://assets.virtuallyhyper.com/2013-09-zabbix_pogo_hd_temp.png)
