...
![lemonldap arch LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-lemonldap-arch.png)
...
![lemonldap ng auth portal LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-lemonldap-ng-auth-portal.png)
...
![lemonldp admin console LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-lemonldp-admin-console.png)
...
![lemonldap auth portal LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-lemonldap-auth-portal.png)
...
![389 console login cres LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-389-console-login-cres.png)

Upon a successful login, you will see the following:

![389 console logged in LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-389-console-logged-in.png)

Then click on the **User and Groups** tab and then click **Create** -> **User**:

![add user 389 console LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-add-user-389-console.png)

After you create the user it should look like this:

![389 console user LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-389-console-user.png)
...
![ldap enabled LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-ldap-enabled.png)
...
![lemon ldap change access to man LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-lemon-ldap-change-access-to-man.png)
...
![enable saml lemonldap LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-enable-saml-lemonldap.png)
...
![lemonldap mail email format LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-lemonldap-mail-email-format.png)
...
![private key generat lemon ldap LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-private-key-generat-lemon-ldap.png)
...
![lemon ldap org name 1024x365 LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-lemon-ldap-org-name.png)
...
![saml metadata for gapps 1024x272 LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-saml-metadata-for-gapps.png)
...
![nameid format lemonldap gapps 1024x373 LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-nameid-format-lemonldap-gapps.png)
...
![sign sso assertion LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-sign-sso-assertion.png)
...
![gapps sso settings 1024x266 LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-gapps-sso-settings.png)
...
![gapps sso settings LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-gapps_sso-settings.png)
...
![gapps application lemonldap ng LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-gapps-application-lemonldap-ng.png)
...
![user loggedin lemonldap 1024x214 LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-user-loggedin-lemonldap.png)
...
![logged into gmail from lemonldap 1024x134 LemonLDAP NG With LDAP and SAML Google Apps](http://assets.virtuallyhyper.com/2014-01-logged-into-gmail-from-lemonldap.png)
