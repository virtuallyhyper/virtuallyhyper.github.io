...
author: karim
comments: true
date: 2014-02-13 14:21:42+00:00
layout: post
slug: lemonldap-ng-ldap-saml-google-apps
...
I wanted to try out a WebSSO program and I ran into [LemonLDAP::NG](http://lemonldap-ng.org/). The application can handle SAML applications and can also do the regular reverse proxy approach for enabling SSO web applications. A list of known working applications can be seen at [Known supported applications](http://lemonldap-ng.org/documentation/1.3/applications)
...
I had a VPS running CentOS which was perfect for the setup. Most of the install instructions for _lemonldap-ng_ are laid out [here](http://lemonldap-ng.org/documentation/1.3/installrpm).
...
There is a **YUM** repository available which holds all the _lemonldap-ng_ packages. To set that up, add the following into the **/etc/yum.repos.d/lemonldap-ng.repo** file:
...
I also enabled the [epel](https://fedoraproject.org/wiki/EPEL) repository and the [rpmforge](http://repoforge.org/) repository to get a lot of other packages that are not available in the default CentOS repo. To enable the **epel** repository I ran the following:
...
I then imported the _lemonldap-ng_ **GPG** key:
...
After that, I was able to import the Lasso module without issues. BTW _liblasso_ is only necessary if you are planning to use the SAML Capabilities within _lemoldap-ng_.
...
There are a couple of configuration steps to setup _lemonldap-ng_.
...
First we need to have a DNS name for the manager (management portal) of _lemonldap-ng_. This is where all the configurations changes occur, sometimes referred to as the **administration portal**. I ended up using: **man.dnsd.me**.
...
Lastly to be able to update configuration from the administration portal, we will need **reload.dnsd.me**. After that is in place we can start configuring _lemonldap-ng_. You can setup each of the components on different servers as shown [here](http://wiki.lemonldap.ow2.org/xwiki/bin/view/NG/Presentation#HArchitecture):





[![lemonldap-arch](http://virtuallyhyper.com/wp-content/uploads/2014/01/lemonldap-arch.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/lemonldap-arch.png)
...
[![lemonldap-ng-auth-portal](http://virtuallyhyper.com/wp-content/uploads/2014/01/lemonldap-ng-auth-portal.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/lemonldap-ng-auth-portal.png)
...
[![lemonldp-admin-console](http://virtuallyhyper.com/wp-content/uploads/2014/01/lemonldp-admin-console.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/lemonldp-admin-console.png)
...
[![lemonldap-auth-portal](http://virtuallyhyper.com/wp-content/uploads/2014/01/lemonldap-auth-portal.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/lemonldap-auth-portal.png)
...
The setup script has a couple of options. For a step by step guide for the _Directory Server_ check out this [guide](http://ostechnix.wordpress.com/2013/02/05/setup-ldap-server-389ds-in-centosrhelscientific-linux-6-3-step-by-step/) or [this](http://www.unixmen.com/setup-directory-serverldap-in-centos-6-4-rhel-6-4/) one.
...
[![389-console-login-cres](http://virtuallyhyper.com/wp-content/uploads/2014/01/389-console-login-cres.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/389-console-login-cres.png)
...
[![389-console-logged-in](http://virtuallyhyper.com/wp-content/uploads/2014/01/389-console-logged-in.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/389-console-logged-in.png)
...
[![add-user-389-console](http://virtuallyhyper.com/wp-content/uploads/2014/01/add-user-389-console.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/add-user-389-console.png)
...
[![389-console-user](http://virtuallyhyper.com/wp-content/uploads/2014/01/389-console-user.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/389-console-user.png)
...
[![ldap-enabled](http://virtuallyhyper.com/wp-content/uploads/2014/01/ldap-enabled.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/ldap-enabled.png)
...
Then go to **General Parameters** -> **Authentication Modules** -> **LDAP parameters** -> **Connection** and set the following settings:
  ...
  * Password => _The directory Manager Password_
...
[![lemon-ldap-change-access-to-man](http://virtuallyhyper.com/wp-content/uploads/2014/01/lemon-ldap-change-access-to-man.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/lemon-ldap-change-access-to-man.png)





Now you can configure _lemonldap-ng_ with the **elatov** user.
...
Now let's setup _lemonldap-ng_ to be a SAML **IDP** (Identity Provider) connecting to the Google Apps **SP** (Service Provider).
...
[![enable-saml-lemonldap](http://virtuallyhyper.com/wp-content/uploads/2014/01/enable-saml-lemonldap.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/enable-saml-lemonldap.png)
...
[![lemonldap-mail-email-format](http://virtuallyhyper.com/wp-content/uploads/2014/01/lemonldap-mail-email-format.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/lemonldap-mail-email-format.png)
...
[![private-key-generat-lemon-ldap](http://virtuallyhyper.com/wp-content/uploads/2014/01/private-key-generat-lemon-ldap.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/private-key-generat-lemon-ldap.png)
...
For completion, fill out your _Organization_ information under **SAML2 Service** -> **Organization** -> **Display Name / Name / URL**:





[![lemon-ldap-org-name](http://virtuallyhyper.com/wp-content/uploads/2014/01/lemon-ldap-org-name-1024x365.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/lemon-ldap-org-name.png)
...
[![saml-metadata-for-gapps](http://virtuallyhyper.com/wp-content/uploads/2014/01/saml-metadata-for-gapps-1024x272.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/saml-metadata-for-gapps.png)
...
[![nameid-format-lemonldap-gapps](http://virtuallyhyper.com/wp-content/uploads/2014/01/nameid-format-lemonldap-gapps-1024x373.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/nameid-format-lemonldap-gapps.png)





Lastly let's disable the advanced features in _lemonldap-ng_. This is done by going to **SAML service provider** -> **gapps** -> **Options** -> **Signature**. Then disable everything except "**Sign SSO message**":





[![sign-sso-assertion](http://virtuallyhyper.com/wp-content/uploads/2014/01/sign-sso-assertion.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/sign-sso-assertion.png)
...
[![gapps-sso-settings](http://virtuallyhyper.com/wp-content/uploads/2014/01/gapps-sso-settings-1024x266.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/gapps-sso-settings.png)
...
Configure the following settings:
  ...
  * Verification certificate => _upload generated certificate (lemonldap.pem)_
...
[![gapps_sso-settings](http://virtuallyhyper.com/wp-content/uploads/2014/01/gapps_sso-settings.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/gapps_sso-settings.png)
...
[![gapps-application-lemonldap-ng](http://virtuallyhyper.com/wp-content/uploads/2014/01/gapps-application-lemonldap-ng.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/gapps-application-lemonldap-ng.png)
...
[![user-loggedin-lemonldap](http://virtuallyhyper.com/wp-content/uploads/2014/01/user-loggedin-lemonldap-1024x214.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/user-loggedin-lemonldap.png)
...
[![logged-into-gmail-from-lemonldap](http://virtuallyhyper.com/wp-content/uploads/2014/01/logged-into-gmail-from-lemonldap-1024x134.png)](http://virtuallyhyper.com/wp-content/uploads/2014/01/logged-into-gmail-from-lemonldap.png)
