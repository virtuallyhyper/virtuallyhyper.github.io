...
The process is described in this [pdf](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-Manual_IPMI.pdf). If you want to be able to use KVM (Keyboard-Video-Mouse) over LAN, make sure you follow the **Enabling COM Port for SOL (IPMI)** section. All the settings were already enabled on my system, all I had to do was assign the IPMI a static IP. Here are the BIOS settings, after I was done:

![IPMI static IP g 1024x705 Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-IPMI_static_IP_g.jpg)
...
![ipmi login page Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-ipmi-login-page.png)
...
![firmware update site Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-firmware-update-site.png)
...
![ipmi fw update Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-ipmi-fw-update.png)

After that the system information looked up-to-date:

![ipmi sys infor Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-ipmi-sys-infor.png)
...
![bios update super Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-bios-update-super.png)
...
![ipmi virtua media Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-ipmi-virtua-media.png)
...
![custom size images rus Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-custom-size-images-rus.png)
...
![freedos boot usb Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-freedos_boot-usb.png)
...
![remote control tab ipmi Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-remote-control-tab-ipmi.png)

Upon clicking **Remote Console**, I saw the server:

![jviewer started Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-jviewer-started.png)
...
![freedos booted Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-freedos-booted.png)

I then started the BIOS update:

![start bios update Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-start-bios-update.png)

After a couple of minutes the BIOS update finished:

![bio update done Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-bio-update-done.png)

That should be it. You can reboot the server by sending a **Ctr-Alt-Del**:

![send cad g Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-send-cad_g.png)
...
![impi config tab Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-impi-config-tab.png)

Then configure your SMTP server settings:

![smtp settings impi Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-smtp-settings-impi.png)
...
![alerts impi Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-alerts-impi.png)
...
![zabbix impi interfaces Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-zabbix-impi-interfaces.png)

Enter the credentials to login into the IPMI system. Here is how my IPMI tab looked like:

![ipmi tab zabbix Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-ipmi-tab-zabbix.png)
...
![system temp item zabbix Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-system-temp-item-zabbix.png)

After I was done adding all the Fans and Temperatures, I was able to see the graphs:

![cpu plot ipmi zabbix Configure IPMI On SuperMicro Server and Monitor IPMI Sensors with Zabbix](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-12-cpu-plot-ipmi-zabbix.png)
