...
author: karim
comments: true
date: 2012-10-08 13:30:21+00:00
layout: post
slug: setup-fedora-14-machine-as-a-wireless-gateway-for-your-internal-network
...
[![](http://virtuallyhyper.com/wp-content/uploads/2012/09/wireless_gateway.png)](http://virtuallyhyper.com/wp-content/uploads/2012/09/wireless_gateway.png)
...
So my card was ready to connect to a wireless network. Since I wanted my wireless card to have a static DHCP IP, I setup the wireless router to assign a static IP to the MAC Address of my Wireless Card. I was using _dd-wrt_ and the setup was pretty simple. If you want to see screenshots, check out "[Static DHCP](http://www.dd-wrt.com/wiki/index.php/Static_DHCP)". In my setup, I assigned the IP of "192.168.1.16" to my Wireless adapter.
...
So _SNAT_ is a static NAT, where _MASQUERADE_ is dynamic NAT. I wasn't sure if I will add more machines to my internal network, but I if I would, I wouldn't want to tinker with my NAT setup. Also I didn't have any public IP addresses, so I decided to set up a MASQUERADE NAT instead of SNAT.
...
[![](http://virtuallyhyper.com/wp-content/uploads/2012/09/double_nat.png)](http://virtuallyhyper.com/wp-content/uploads/2012/09/double_nat.png)
