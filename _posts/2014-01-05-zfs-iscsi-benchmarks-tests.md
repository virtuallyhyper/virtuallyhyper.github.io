...
![napp it benchmarks g ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-napp-it-benchmarks_g.png)

Doing a quick **DD** test yielded the following:

![napp it dd test ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-napp-it-dd-test.png)
...
![hd specs ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-hd-specs.png)
...
![iozon test ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-iozon-test.png)

The sequential write was about the same speed **175MB/s**. A **bonnie++** test, yielded slightly higher speeds:

![bonnie test ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-bonnie_test.png)
...
![dd first try g ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-dd-first-try_g.png)
...
![enable write cache ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-enable-write-cache.png)
...
![davg after wirte cache enabled ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-davg-after-wirte-cache-enabled.png)
...
![iometer results reg test1 ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-iometer-results-reg-test1.png)
...
![iometer big tests1 ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-iometer-big-tests1.png)
...
![linux vm dd g ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-linux_vm_dd_g.png)
...
![linux vm dd 32bit max sec g ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-linux_vm_dd_32bit_max_sec_g.png)
...
![zfs block sizes ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-zfs-block-sizes.png)

![zfs ds examples ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-zfs-ds-examples.png)
...
![nic usage ZFS iSCSI Benchmark Tests on ESX](http://assets.virtuallyhyper.com/2013-12-nic-usage.png)
