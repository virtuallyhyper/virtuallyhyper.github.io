...
![vum_net_ports](http://assets.virtuallyhyper.com/2012-12-vum_net_ports.png)
...
![shared_repository_vum](http://assets.virtuallyhyper.com/2012-12-shared_repository_vum.png)
...
![vum_smart-booting](http://assets.virtuallyhyper.com/2012-12-vum_smart-booting.png)
...
![vum-import-patch](http://assets.virtuallyhyper.com/2012-12-vum-import-patch.png)

Click Next to upload the patch, during the upload you will see the progress like so:

![progress_import_patch_vum](http://assets.virtuallyhyper.com/2012-12-progress_import_patch_vum.png)

When the upload is done you will see a list of patches, including yours:

![finished_import_of_patch_vum](http://assets.virtuallyhyper.com/2012-12-finished_import_of_patch_vum.png)
...
>
> ![import_esxi_image_vum](http://assets.virtuallyhyper.com/2012-12-import_esxi_image_vum.png)
>
...
>
> ![create_new_baseline_vum](http://assets.virtuallyhyper.com/2012-12-create_new_baseline_vum.png)
>
> ![esxi_image_vum](http://assets.virtuallyhyper.com/2012-12-esxi_image_vum.png)
>
...
>
> ![host_update_vum_p4](http://assets.virtuallyhyper.com/2012-12-host_update_vum_p4.png)
>
...
>
> ![host_update_vum_p3_1](http://assets.virtuallyhyper.com/2012-12-host_update_vum_p3_1.png)
>
...
>
> ![host_update_vum_p5](http://assets.virtuallyhyper.com/2012-12-host_update_vum_p5.png)
>
...
>
> ![vum_upgrade_baselines](http://assets.virtuallyhyper.com/2012-12-vum_upgrade_baselines.png)
>
> ![vum_extension_baselines](http://assets.virtuallyhyper.com/2012-12-vum_extension_baselines.png)
...
>     ![options_for_excel_for_vum](http://assets.virtuallyhyper.com/2012-12-options_for_excel_for_vum.png)
...
![create_new_baseline_for_va_update](http://assets.virtuallyhyper.com/2012-12-create_new_baseline_for_va_update.png)

Next Create a Vendor Rule:

![create_vendor_rule_for_va_update](http://assets.virtuallyhyper.com/2012-12-create_vendor_rule_for_va_update.png)

Here are the options for the Vendor Rules:

![vendor_rules_options_va_update](http://assets.virtuallyhyper.com/2012-12-vendor_rules_options_va_update.png)
...
![non-compliant_va_for_update](http://assets.virtuallyhyper.com/2012-12-non-compliant_va_for_update.png)

Click "Scan" from the same screen and select the type of scan:

![va_vum_scan](http://assets.virtuallyhyper.com/2012-12-va_vum_scan.png)

Then click on "Remediate" to actually perform the upgrade:

![remediate_va_update](http://assets.virtuallyhyper.com/2012-12-remediate_va_update.png)
...
![1st_window_vum_utility](http://assets.virtuallyhyper.com/2012-12-1st_window_vum_utility.png)

![vum_utility](http://assets.virtuallyhyper.com/2012-12-vum_utility.png)
