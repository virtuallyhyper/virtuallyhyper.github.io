...
![picard no match g Organizing Your Music Library Using Acoustic Fingerprinting](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-01-picard_no_match_g.png)

Notice at the bottom it says "No Matching Tracks above the threshold for file". I tried enabling Fingerprinting:

![picard finger printing enabled Organizing Your Music Library Using Acoustic Fingerprinting](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-01-picard_finger_printing_enabled.png)

I also enabled the *lastfm* plugin:

![picard lastfm plugin Organizing Your Music Library Using Acoustic Fingerprinting](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-01-picard_lastfm_plugin.png)
...
![easytag started Organizing Your Music Library Using Acoustic Fingerprinting](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-01-easytag_started.png)

Then navigate to your folder/playlist, it will looks something like this:

![easy tag load folder Organizing Your Music Library Using Acoustic Fingerprinting](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-01-easy_tag_load_folder.png)
...
![easy tag scanner fill tags g Organizing Your Music Library Using Acoustic Fingerprinting](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-01-easy_tag_scanner_fill_tags_g.png)
...
![fill tag pattern Organizing Your Music Library Using Acoustic Fingerprinting](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-01-fill_tag_pattern.png)
...
![fill tags after scan Organizing Your Music Library Using Acoustic Fingerprinting](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-01-fill_tags_after_scan.png)

After that, to save the changes, close the scanner window and go to "File" -> "Save Files":

![easytag savefiles g Organizing Your Music Library Using Acoustic Fingerprinting](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-01-easytag_savefiles_g.png)
...
![confirm save files Organizing Your Music Library Using Acoustic Fingerprinting](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-01-confirm_save_files.png)

After it's done, in the logs pane you will see messages like "Updated Tag" like so:

![easytag saved tags Organizing Your Music Library Using Acoustic Fingerprinting](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-01-easytag_saved_tags.png)
