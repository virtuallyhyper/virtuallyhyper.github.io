...
![freebsd_kernel_panic_copy_ntfs](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-10-freebsd_kernel_panic_copy_ntfs.png)
...
so I went ahead and edited the 'patch-fuse_module__fuse_vnops.c' file and added the changes described in the above page. [Here](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-10-patch-fuse_module__fuse_vnops.c) is my final patch file. I then removed both packages:
...
I then applied my new patch file:
	...
	elatov@freebsd:~>fetch https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-10-patch-fuse_module__fuse_vnops.c
