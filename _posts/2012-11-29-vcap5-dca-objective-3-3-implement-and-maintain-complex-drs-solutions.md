...
>
> ![drs_load_balancing](http://assets.virtuallyhyper.com/2012-10-drs_load_balancing.png)
>
...
![dpm_cluster_settings](http://assets.virtuallyhyper.com/2012-10-dpm_cluster_settings.png)

### Configure EVC using appropriate baseline

From VMware KB [1003212](http://kb.vmware.com/kb/1003212) here is are the baselines:

![evc_baselines](http://assets.virtuallyhyper.com/2012-10-evc_baselines.png)

and here is a table from the same KB:

![evc_baselines_table](http://assets.virtuallyhyper.com/2012-10-evc_baselines_table.png)
...
![change_evc_mode](http://assets.virtuallyhyper.com/2012-10-change_evc_mode.png)
...
>
> ![dpm_events](http://assets.virtuallyhyper.com/2012-10-dpm_events.png)
>
...
![create_alarm_for_DRS](http://assets.virtuallyhyper.com/2012-10-create_alarm_for_DRS.png)
...
>
> ![power_mgmt_policies](http://assets.virtuallyhyper.com/2012-10-power_mgmt_policies.png)
>
...
> 7.  Click the Automation Level column and select an automation level from the drop-down menu.![drs_automation_levels](http://assets.virtuallyhyper.com/2012-10-drs_automation_levels.png)
> 8.  Click OK.

Here is how it looks like in vCenter:

![vm_automation_levels](http://assets.virtuallyhyper.com/2012-10-vm_automation_levels.png)
...
> 4.  Click Next.
> 5.  Select a default automation level for DRS.![drs_automatiion_levels](http://assets.virtuallyhyper.com/2012-10-drs_automatiion_levels.png)
