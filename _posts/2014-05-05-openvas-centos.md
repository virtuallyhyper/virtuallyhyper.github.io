...
![openvas components OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-openvas-components.png)
...
![greenbone assistant OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-greenbone-assistant.png)

After logging in you should see the following:

![gsa first page OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-gsa-first-page.png)

Then add a target host, by going to **Configuration** -> **Targets**:

![gsa conf targets OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-gsa-conf-targets.png)

Then click on the *star* to add a target:

![gsa new target button OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-gsa-new-target-button.png)

Fill out all the information:

![gsa new target filled out OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-gsa-new-target-filled-out.png)

Then click on "**Create Target**" and you should see your new target added:

![gsa list of targets OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-gsa-list-of-targets.png)

Then let's create a task to run a scan against our newly created target. Go to **Scan Management** -> **New Task**:

![gsa sm nt OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-gsa-sm-nt.png)

Then fill out all the information:

![new task filledout OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-new-task-filledout.png)

Click on "**Create Task**" and the task should be ready:

![task created OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-task-created.png)

BTW here are all the available scan configuration from the default install:

![scan configuration gsa OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-scan-configuration-gsa.png)

Lastly click on the *play* button to start the scan:

![start scan button gsa OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-start-scan-button-gsa.png)

Here is the scan kicked off:

![scan started OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-scan-started.png)

### Getting OpenVAS Scan Results

After the scan is finished, you will see the following under the **Tasks** section:

![scan finished OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-scan-finished.png)

Click on the scan and you will see the details:

![task details gsa OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-task-details-gsa.png)

Then click on the "**Magnifying Glass**" (to see the details of the report) and you will see the following:

![report details gsa OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-report-details-gsa.png)
...
![arachni missing in results OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-arachni-missing-in-results.png)

> Arachni could not be found in your system path.

And also the following:

![wapiti empty report OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-wapiti-empty-report.png)
...
![arachni results included i OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-arachni-results-included_i.jpg)
...
![watipi results included i1 OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-watipi-results-included_i1.jpg)
...
![snort catching openvas scan i2 OpenVAS on CentOS](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-snort-catching-openvas-scan_i2.jpg)
