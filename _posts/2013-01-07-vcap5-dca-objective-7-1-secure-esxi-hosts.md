...
![users groups vscl VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-users_groups-vscl.png)

![add new user VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-add_new_user.png)
...
![esx groups VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-esx_groups.png)

![add group VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-add_group.png)
...
![dcui ssh enabled VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-dcui_ssh_enabled.png)
...
![enabled ssh vscl VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-enabled_ssh_vscl.png)
...
![vcenter verify ssl certs VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-vcenter_verify_ssl_certs.png)
...
>
> ![lockdown behavior VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-lockdown_behavior.png)
>
...
>
> ![lockdown conf VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-lockdown_conf.png)
...
![lockdown from host VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-lockdown_from_host.png)

![enable lock down mode VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-enable_lock_down_mode.png)
...
![lockdown mode dcui VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-lockdown_mode_dcui.png)

![conf lock down mode VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-conf_lock_down_mode.png)
...
>     ![iis for cam service VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-iis_for_cam_service.png)
...
>     ![cam certificate option VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-cam_certificate_option.png)
...
> **Procedure**
>
> 1.  On the authentication proxy server system, use the IIS Manager to export the certificate. ![export cam cert with iis VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-export_cam_cert_with_iis.png)
...
![VM advanced parameters VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-VM_advanced_parameters.png)
...
>     Here is how it looks like from vCenter:
>
>     ![ad integration VCAP5 DCA Objective 7.1 – Secure ESXi Hosts ](http://assets.virtuallyhyper.com/2012-12-ad_integration.png)
>
