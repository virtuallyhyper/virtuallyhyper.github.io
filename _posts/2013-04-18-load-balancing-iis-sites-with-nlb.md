...
![NLB IIS Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-NLB_IIS.jpg)
...
![server manager NLB selected Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-server_manager_NLB_selected.png)
...
![nlbmgr started Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr-started.png)

Then from the Menu Bar go to "Cluster" -> "New":

![nlb mgr cluster new g Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlb_mgr_cluster_new_g.png)
...
![nlbmgr ints from host Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr-ints-from-host.png)

After you click "Next" you will see the "Host Parameters" window, you can leave all the default options here:

![nlbmgr host params Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr_host_params.png)

Click "Next" and it will take you to the "Cluster IP Addresses" screen:

![nlbmgr cluster ips Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr-cluster-ips.png)

From here click "Add" and enter the IP that will be used as the "Cluster" IP address. In my case it was 192.168.250.51:

![nlbmgr add ip ad Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr_add_ip-ad.png)
...
![nlbmgr clus params filled out Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr_clus_params_filled_out.png)

After you click "Next" you will see the "Port Rules" screen:

![nlbmgr port rules Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr_port_rules.png)

If you click "Edit" it will show you the default rule set:

![nlbmgr edit port rule Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr_edit_port_rule.png)
...
![nlbmgr node1 added Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr_node1_added.png)

Now to add the second node. Right click on the cluster and select "Add Host To Cluster":

![nlbmgr add host to cluster g Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr_add_host_to_cluster_g.png)
...
![nlbmgr interface second node Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr_interface_second_node.png)

Select the Primary Interface and click "Next" and you will be taken to the "Host Parameters" screen:

![nlbmgr host params2 Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr_host_params2.png)
...
![nlbmgr edit rule node2 Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr_edit_rule_node2.png)
...
![nlbmgr converged node2 Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr_converged_node2.png)
...
![chrome test IIS 1 Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-chrome_test_IIS-1.png)
...
![nlbmgr stop host Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr_stop_host.png)

If the process is successful you will see the node in a "Red" state:

![nlbmgr 2nd node stopped Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-nlbmgr_2nd_node_stopped.png)

Now from the client go to the same page (**http://cluster/test.html**) and you should see the following:

![chrome test IIS2 Load Balancing IIS Sites with NLB](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-04-chrome_test_IIS2.png)
