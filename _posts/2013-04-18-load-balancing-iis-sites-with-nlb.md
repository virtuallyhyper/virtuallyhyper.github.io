...
author: karim
comments: true
date: 2013-04-18 15:09:51+00:00
layout: post
slug: load-balancing-iis-sites-with-nlb
...
[![NLB_IIS](http://virtuallyhyper.com/wp-content/uploads/2013/04/NLB_IIS.jpg)](http://virtuallyhyper.com/wp-content/uploads/2013/04/NLB_IIS.jpg)
...
I setup both of the IIS Servers in same manner as I described in [this](http://virtuallyhyper.com/2013/04/deploying-a-test-windows-environment-in-a-kvm-infrastucture) post. Since both of the IIS Servers were VMs running on KVM, I was able to easily add a secondary network interfaces to both VMs and ensure that they are on the same network. I will be using NLB in _Unicast_ mode and that is why two interfaces is necessary (I will talk more about that later).
...
[![server_manager_NLB_selected](http://virtuallyhyper.com/wp-content/uploads/2013/04/server_manager_NLB_selected.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/server_manager_NLB_selected.png)
...
[![nlbmgr-started](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr-started.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr-started.png)
...
[![nlb_mgr_cluster_new_g](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlb_mgr_cluster_new_g.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlb_mgr_cluster_new_g.png)
...
[![nlbmgr-ints-from-host](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr-ints-from-host.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr-ints-from-host.png)
...
[![nlbmgr_host_params](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_host_params.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_host_params.png)
...
[![nlbmgr-cluster-ips](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr-cluster-ips.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr-cluster-ips.png)
...
[![nlbmgr_add_ip-ad](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_add_ip-ad.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_add_ip-ad.png)
...
[![nlbmgr_clus_params_filled_out](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_clus_params_filled_out.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_clus_params_filled_out.png)
...
[![nlbmgr_port_rules](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_port_rules.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_port_rules.png)
...
[![nlbmgr_edit_port_rule](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_edit_port_rule.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_edit_port_rule.png)





By default it's setup to load balance all the ports "0-65535" and that will work for our setup. If you wanted to be pedantic you could create one rule to only balance port 80, but the default is okay. Now the _Affinity_ setting is noteworthy, cause it basically decides how the load balancing occurs. [This](http://technet.microsoft.com/en-us/library/cc778263%28v=ws.10%29.aspx) Microsoft article explains the different modes, here are the important excerpts:
...
Both of the IIS Servers weren't using any sessions so the _Affinity_ didn't really matter in my setup, so I left the default "Single" option. At this point we are ready to click "Finish" and as soon as we do we will see the first Node getting added to the cluster. If it's successful we will see the following:





[![nlbmgr_node1_added](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_node1_added.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_node1_added.png)
...
[![nlbmgr_add_host_to_cluster_g](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_add_host_to_cluster_g.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_add_host_to_cluster_g.png)
...
[![nlbmgr_interface_second_node](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_interface_second_node.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_interface_second_node.png)
...
[![nlbmgr_host_params2](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_host_params2.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_host_params2.png)





Leave the defaults and click "Next". You will then be taken to the same "Port Rules" screen. Click Edit and make sure "Single" mode is selected for the _Affinity_ setting:





[![nlbmgr_edit_rule_node2](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_edit_rule_node2.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_edit_rule_node2.png)
...
[![nlbmgr_converged_node2](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_converged_node2.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_converged_node2.png)
...
[![chrome_test_IIS-1](http://virtuallyhyper.com/wp-content/uploads/2013/04/chrome_test_IIS-1.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/chrome_test_IIS-1.png)
...
[![nlbmgr_stop_host](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_stop_host.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_stop_host.png)
...
[![nlbmgr_2nd_node_stopped](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_2nd_node_stopped.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/nlbmgr_2nd_node_stopped.png)
...
[![chrome_test_IIS2](http://virtuallyhyper.com/wp-content/uploads/2013/04/chrome_test_IIS2.png)](http://virtuallyhyper.com/wp-content/uploads/2013/04/chrome_test_IIS2.png)
