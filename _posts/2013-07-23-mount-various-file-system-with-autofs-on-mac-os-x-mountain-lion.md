...
![mac ports install Mount Various File Systems with Autofs on Mac OS X Mountain Lion](http://assets.virtuallyhyper.com/2013-07-mac_ports_install.png)
...
![xcode install app store Mount Various File Systems with Autofs on Mac OS X Mountain Lion](http://assets.virtuallyhyper.com/2013-07-xcode-install-app-store.png)

#### Install X-Code Command Line tools:

Go to your Applications (Command-Shift-a) and launch X-Code (accept the license agreement). Then go to the preferences:

![xcode preferences Mount Various File Systems with Autofs on Mac OS X Mountain Lion](http://assets.virtuallyhyper.com/2013-07-xcode-preferences.png)
...
![xcode command line tools Mount Various File Systems with Autofs on Mac OS X Mountain Lion](http://assets.virtuallyhyper.com/2013-07-xcode-command-line-tools.png)
