...
![xbian download OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-xbian-download.png)
...
![Rpi great OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-Rpi-great.jpg)
...
![xbian config OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-xbian-config.png)
...
![openelec downloads page OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-openelec-downloads-page.png)
...
![openelec wizard OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-openelec-wizard.png)
...
![xtv saf skin enabled OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-xtv-saf-skin-enabled.png)
...
![openelec settings OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-openelec-settings.png)
...
![pi cpu usage OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-pi-cpu-usage.png)

and here is the network:

![pi eth0 usage OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-pi-eth0-usage.png)
...
![addons enabled addons OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-addons-enabled-addons.png)

Then click on **Enabled-Addons**, scroll down to the **XBMC Backup** Addon, select it, and you should see this:

![xbmc backup configure OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-xbmc-backup-configure.png)

Then click on **configure** and you will see the following:

![xbmc backup general OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-xbmc-backup_general.png)
...
![xbmc backup browse directory OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-xbmc-backup-browse-directory.png)
...
![xbmc program OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-xbmc-program.png)

Select **XBMC Backup**:

![xbmc backup manual backup OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-xbmc-backup-manual-backup.png)

Then select **Backup** and you should see the backup start:

![xbmc backup manual backup going OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-xbmc-backup-manual-backup_going.png)
...
![crontab openelec OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-crontab-openelec.png)
...
![openelec unoff repo OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-openelec-unoff-repo.png)
...
![xbmc addon install from zip OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-xbmc-addon-install-from-zip.png)

Then browse to your home directory and select the zip archive:

![select unof repo zip OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-select-unof-repo-zip.png)

After it's installed you should see the following:

![unof repo enabled OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-unof-repo-enabled.png)
...
![addon screen get addons OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-addon-screen-get-addons.png)

Then select the **Unofficial OpenELEC Repository**:

![select unof repo for addons OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-select-unof-repo-for-addons.png)

Then select **Program Add-ons**:

![program addons from unof repo OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-program-addons-from-unof-repo.png)

and then select **rsync**:

![select rsync plugin from unof repo OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-select-rsync-plugin-from-unof-repo.png)

After it's installed you should see the following:

![rsync plugin installed OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-rsync-plugin-installed.png)
...
![xbmc general settings OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-xbmc-general-settings.png)

Here is the **Hardware** information:

![xbmc hardware info OpenELEC on Raspberry Pi](http://assets.virtuallyhyper.com/2013-11-xbmc-hardware-info.png)
