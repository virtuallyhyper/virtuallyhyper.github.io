...
>
> ![load_balancing_algorithms](http://assets.virtuallyhyper.com/2012-09-load_balancing_algorithms.png)
>
> In the Network failover detection list, select the option to use for failover detection.
>
> ![network_failover_detection](http://assets.virtuallyhyper.com/2012-09-network_failover_detection.png)

Also from the same document, here is a summary of all the policies:

> Specify the settings in the Policy Exceptions group
>
> ![portgroup_network_policies](http://assets.virtuallyhyper.com/2012-09-portgroup_network_policies.png)
...
![vswitch_example](http://assets.virtuallyhyper.com/2012-10-vswitch_example.png)
