...
author: karim
comments: true
date: 2012-09-04 19:19:35+00:00
layout: post
slug: vcap5-dcd-objective-3-6-determine-datacenter-management-options-for-a-vsphere-5-physical-design
title: 'VCAP5-DCD Objective 3.6 – Determine Datacenter Management Options for a vSphere
  5 Physical Design '
wordpress_id: 3319
categories:
- VCAP5-DCD
...
[![](http://virtuallyhyper.com/wp-content/uploads/2012/09/vmware-mgmg-tools.png)](http://virtuallyhyper.com/wp-content/uploads/2012/09/vmware-mgmg-tools.png)
...
[Objective 3.4](http://virtuallyhyper.com/2012/09/vcap5-dcd-objective-3-4-determine-appropriate-compute-resources-for-a-vsphere-5-physical-design/) and [Objective 3.5](http://virtuallyhyper.com/2012/09/vcap5-dcd-objective-3-5-determine-virtual-machine-configuration-for-a-vsphere-5-physical-design/). Both objectives cover HA and FT pretty well. But in addition, from [this](http://virtuallyhyper.com/wp-content/uploads/2013/04/vcap-dcd_notes.pdf) PDF:
...
Check out [Objective 3.3](http://virtuallyhyper.com/2012/08/vcap5-dcd-objective-3-3-create-a-vsphere-5-physical-storage-design-from-an-existing-logical-design/), both are discussed there. I didn't talk much about Storage vMotion, so from "[Performance Best Practices for VMware vSphere 5.0](http://www.vmware.com/pdf/Perf_Best_Practices_vSphere5.0.pdf)":
...
[![](http://virtuallyhyper.com/wp-content/uploads/2012/09/vc-heartbeat.png)](http://virtuallyhyper.com/wp-content/uploads/2012/09/vc-heartbeat.png)
...
Many tasks require permissions on more than one object in the inventory. You can review the privileges required to perform the tasks and, where applicable, the appropriate sample roles. The following table lists common tasks that require more than one privilege. You can use the Applicable Roles on the inventory objects to grant permission to perform these tasks, or you can create your own roles with the equivalent required privileges. [![](http://virtuallyhyper.com/wp-content/uploads/2012/09/pemissions-to-create-vms.png)](http://virtuallyhyper.com/wp-content/uploads/2012/09/pemissions-to-create-vms.png)
> 
> 
...
> 
> [![](http://virtuallyhyper.com/wp-content/uploads/2012/09/vmware-go.png)](http://virtuallyhyper.com/wp-content/uploads/2012/09/vmware-go.png)   
...
[![](http://virtuallyhyper.com/wp-content/uploads/2012/09/vm-serv-mana-sub-request.png)](http://virtuallyhyper.com/wp-content/uploads/2012/09/vm-serv-mana-sub-request.png)





Lastly you can use the 'Asset Tag' option for a VM to keep track of VMs manually. You can also use PowerCLI to look for VMs with certain tag as well. VMware Blog "[Accessing Virtual Machine Advanced Settings](http://blogs.vmware.com/vsphere/2012/03/acessing-virtual-machine-advanced-settings.html)" talks about the process. Of course use VMware Configuration Manager to keep track of configuration changes. This was discussed in [Objective 2.4](http://virtuallyhyper.com/2012/08/vcap5-dcd-objective-2-4-build-manageability-requirements-into-the-logical-design/)
...
If you don't want to use VUM because you don't have a big environment there are alternatives. First you can create your own custom image with Image Builder. For more information check out the VMware blog "[Using the vSphere ESXi Image Builder CLI](http://blogs.vmware.com/vsphere/2012/04/using-the-vsphere-esxi-image-builder-cli.html)". There is also a pretty example in "[VMware vSphere 5.0 Evaluation Guide Volume One](http://www.vmware.com/files/pdf/products/vsphere/VMware-vSphere-Evaluation-Guide-1.pdf)". From that document, here is a good image that depicts Image Builder:





[![](http://virtuallyhyper.com/wp-content/uploads/2012/09/image_builder.png)](http://virtuallyhyper.com/wp-content/uploads/2012/09/image_builder.png).
...
> 
> [![](http://virtuallyhyper.com/wp-content/uploads/2012/09/pxe-boot-esxi.png)](http://virtuallyhyper.com/wp-content/uploads/2012/09/pxe-boot-esxi.png)
> 
> 
...
> 
> [![](http://virtuallyhyper.com/wp-content/uploads/2012/09/auto-deploy-architecture.png)](http://virtuallyhyper.com/wp-content/uploads/2012/09/auto-deploy-architecture.png)
> 
> 
...
> 
> [![](http://virtuallyhyper.com/wp-content/uploads/2012/09/auto-deploy-fb.png)](http://virtuallyhyper.com/wp-content/uploads/2012/09/auto-deploy-fb.png)
> 
> 
...
> 
> [![](http://virtuallyhyper.com/wp-content/uploads/2012/09/auto-deploy-sb.png)](http://virtuallyhyper.com/wp-content/uploads/2012/09/auto-deploy-sb.png)
> 
> 
...
The paper talks about being pro-active, defining roles for different layers, and having integrated management. All of these thing are true and there are a lot of third party application that already do this. I talked about these in [Objective 2.4](http://virtuallyhyper.com/2012/08/vcap5-dcd-objective-2-4-build-manageability-requirements-into-the-logical-design/). Also VMware provides this product called VMware Service Manager that allows for incident tracking. I talked it about earlier. There is actually a course on the product. From "[VMware Service Manager: Implementing Incident Problem Management](http://mylearn.vmware.com/descriptions/EDU_DATASHEET_VSMImplementingIPMgmt_V9.pdf)" class data sheet:
