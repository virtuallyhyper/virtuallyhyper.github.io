...
![beltane login page Install Samhain with Beltane on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-beltane-login-page.png)
...
![samhain configure mysql db 1024x751 Install Samhain with Beltane on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-samhain-configure-mysql-db.png)

After that you should see some of the logs:

![beltane alert 1024x336 Install Samhain with Beltane on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-beltane-alert.png)

As a test I created a new file and made sure the event was in Beltane:

![test create file 1024x615 Install Samhain with Beltane on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-test-create-file.png)
