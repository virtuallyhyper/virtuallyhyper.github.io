...
![connected virt manager Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-connected_virt-manager.png)
...
![virt manager connection details Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-virt_manager_connection_details.png)

After selecting that you will see the following window:

![ssh x kvm conn details g Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-ssh-x-kvm-conn-details_g.png)
...
![virt manager create new vm button Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-virt-manager_create-new-vm-button.png)

And that will start the "Create New VM" Wizard:

![create new vm wizard step1 Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-create_new_vm-wizard_step1.png)
...
![create new vm wizard step1 filled out Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-create_new_vm_wizard_step1_filled_out.png)

Then you will see the 2nd step of the wizard: ![create new vm wizard step2 Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-create_new_vm_wizard_step2.png)

Select "Use ISO image", click on "Browse", and then you will see the available Storage Pools:

![create new vm wizard step2 browse storage volumes Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-create_new_vm_wizard_step2_browse_storage_volumes.png)
...
![create new vm step2 locate iso dialogue Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-create_new_vm_step2_locate_iso_dialogue.png)
...
![create new vm step2 filled out Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-create_new_vm_step2_filled_out.png)

Then click "Forward" and then we will get to step 3 of the wizard:

![create new vm step3 Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-create_new_vm_step3.png)
...
![microsoft min reqs Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-microsoft_min_reqs.png)

I just kept 1CPU and 1GB of RAM and clicked "Forward", at which point I saw step 4 of the wizard:

![create new vm step4 Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-create_new_vm_step4.png)
...
![create new vm wizard step4 filled out Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-create_new_vm_wizard_step4_filled_out.png)

I then clicked "Forward" and it took to the 5th step (the last step):

![create new vm wizard step5 Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-create_new_vm_wizard_step5.png)
...
![create new vm console Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-create_new_vm_console.png)

Keep going through the install as you would usually do. Here is a screenshot of the install process going:

![create new vm windows install process Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-create_new_vm_windows_install_process.png)
...
![searching for available hypervisors Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-searching_for_available_hypervisors.png)

Since we are not running one locally you will get error like this:

![failure to connect to libvirtd Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-failure_to_connect_to_libvirtd.png)

You can just close that and then you will see your **virt-manager** in a disconnected state:

![virt manager not connected Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-virt-manager_not_connected.png)

At this point go to "File" -> "Add Connection":

![virt manager add connection Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-virt-manager_add_connection.png)

Then go ahead and fill out the necessary information:

![add connection filled out Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-add_connection_filled_out.png)

If you hit connect it will ask for you the virtuser password:

![ssh password g Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-ssh_password_g.png)
...
![remote virt manager Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-remote_virt-manager.png)
...
![server manager started Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-server_manager_started.png)

Then go to "Roles" and click on "Add Roles":

![blank roles win2k8 Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-blank_roles_win2k8.png)

From the list select "Active Directory Domain Services":

![dc role selected Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-dc_role_selected.png)

Then click "Next" and couple of times, followed by a "Finish". After the install is done you will see the following:

![dc install finished Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-dc_install_finished.png)
...
![ad setup wizard Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-ad_setup_wizard.png)

Click "Next" a couple of times and you see the "Choose Deployment Configuration" window:

![choose deployment conf ad wizard Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-choose_deployment_conf_ad_wizard.png)

I didn't have an existing domain, so I selected "Create a New Domain in a new forest" and clicked next:

![name forest room domain ad wizard Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-name_forest_room_domain_ad_wizard.png)

For my domain I chose "elatov.local":

![elatov local name ad wizard Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-elatov_local_name_ad_wizard.png)

After clicking "Next" I was presented with the following screen:

![set forest functionality lelel ad wiz Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-set_forest_functionality_lelel_ad_wiz.png)
...
![set domain functional level ad wiz Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-set_domain_functional_level_ad_wiz.png)

Same thing here, I left the default and clicked "Next". I was then asked to setup a DNS server:

![additional domain controller options Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-additional_domain_controller_options.png)
...
![location of db log ad wiz Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-location_of_db_log_ad_wiz.png)
...
![dir ser rest mode admin pass ad wiz Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-dir_ser_rest_mode_admin_pass_ad_wiz.png)

After that I was presented with the "Summary" page:

![summary ad wiz Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-summary_ad_wiz.png)

After clicking "Next" the install process started, after the install was finished I saw the following:

![ad setup finished ad wizard Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-ad_setup_finished_ad_wizard.png)

Selecting "Finish" from the above window prompted for a restart. After the restart I saw the following at the login screen:

![ad server joined to domain Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-ad_server_joined_to_domain.png)
...
![servermanager started1 Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-servermanager_started1.png)

Click on "Roles":

![servermanager roles selected Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-servermanager_roles-selected.png)

Then click on "Add Roles", and you will see the "Add Roles Wizard":

![add roles wizard Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-add_roles_wizard.png)

Select "Web Server (IIS)":

![Web server selected roles wiz Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-Web_server_selected_roles_wiz.png)

Then click "Next" until you get to the "Select Role Services":

![web server role services Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-web_server_role_services.png)
...
![iis installing Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-iis_installing.png)

After the install is finished, open Internet Explorer and point it to **http://localhost** you should see the following:

![IE IIS Installed Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-IE_IIS_Installed.png)
...
![inetmgr started Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-inetmgr_started.png)
...
![inetmgr server certificates Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-inetmgr_server_certificates.png)

Then double click on "Server Certificates" and you will see the following:

![server certificated from iis Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-server_certificated_from_iis.png)

Then from the "Right Pane" select "Create Self-Signed Certificate" and the Wizard will start up. Enter the name of the site:

![create self signed certificate Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-create_self_signed_certificate.png)

Then click "OK". You will then see the following under the "Server Certificates":

![server certificates self signed cert created Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-server_certificates_self_signed_cert_created.png)
...
![inetmgr default site selected Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-inetmgr_default_site_selected.png)

On the right you will see an option called "Binding". Click on that and the following will show up:

![inetmgr site bindings Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-inetmgr_site_bindings.png)

Then click "add" and you see the following:

![add site binding inetmgr Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-add_site_binding_inetmgr.png)

Then change the type to 'https" and select the SSL certificate that we created. In the end it will look like this:

![add site binding filled out inetmgr Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-add_site_binding_filled_out_inetmgr.png)
...
![IE with https IIS Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-IE_with_https_IIS.png)
...
![sys properties client Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-sys_properties_client.png)

Then click "Change" and fill out the Computer Name and the domain you want to join:

![filled out join domain Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-filled_out_join_domain.png)

Then click "OK" and you will need to enter the Domain Administrator's credentials to allow this machine to join:

![join domain security creds Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-join_domain_security_creds.png)

If all is successful you will see the following prompt:

![successful join to domain Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-successful_join_to_domain.png)
...
![dsa msc Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-dsa_msc.png)

Expand your domain (elatov.local), then go to "Computers" and you should see the newly added computer there:

![dsa comp added Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-dsa_comp_added.png)

In the same window add a new user by right clicking on the "Users" folder and selecting "Add" -> "User":

![add user from dsa msc g Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-add_user_from_dsa_msc_g.png)

Here is an example of one user I added:

![add user dialogue Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-add_user_dialogue.png)

After we are done adding the user we will see it in the User's list:

![dsa msc user addedd Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-dsa_msc_user_addedd.png)

Then from the client log in with that user, like so:

![login to domain from windows7 client Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-login_to_domain_from_windows7_client.png)

To login to the local user, hit switch user and then type: **.\elatov** along the password:

![login to local windows7 client Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-login_to_local_windows7_client.png)
...
![dnsmgmt started Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-dnsmgmt_started.png)
...
![dnsmgmt added machine Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-dnsmgmt_added_machine.png)
...
![edit vm details Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-edit_vm_details.png)

Notice the VM is a "Shutoff" state, at that point the Console to the VM will open:

![vm details vm off Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-vm_details_vm_off.png)

Right Next to the "Console" button there is a "Details" button, by clicking that you will see the following:

![vm details window Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-vm_details_window.png)

From the left pane, select "Video" and you will see this:

![vm details video panel Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-vm_details_video_panel.png)

Change the Model from "vga" to "qxl":

![vm details change video to glx Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-vm_details_change_video_to_glx.png)

Then select "Apply" and then select "Display VNC" and you will see the following:

![vm details vnc display panel Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-vm_details_vnc_display_panel.png)
...
![vm details change from vnc spice pop up Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-vm_details_change_from_vnc_spice_pop_up.png)

Click "Yes", after you click "Yes" you will see a new device added called "Channel" like so:

![vm details spice channel added Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-vm_details_spice_channel_added.png)
...
![spice download page from vm Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-spice_download_page_from_vm.png)

Scroll down until you see the "Windows guest tools":

![spice guest windows tools from vm in IE Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-spice_guest_windows_tools_from_vm_in_IE.png)

Download the tools onto the desktop:

![spice tools downloaded on desktop in VM Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-spice_tools_downloaded_on_desktop_in_VM.png)

Then double click on the installer and follow the onscreen instructions:

![spice installer in VM Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-spice_installer_in_VM.png)
...
![spicec logged in Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-spicec_logged_in.png)
...
![remote viewer spice Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-remote-viewer_spice.png) and lastly with **spicy**:
...
![sipcy filled out Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-sipcy_filled_out.png)

and then you will see the following:

![spicy connected Deploying a Test Windows Environment in a KVM Infrastucture](http://assets.virtuallyhyper.com/2013-04-spicy_connected.png)
