...
>
> ![rhel6 welcome screen RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_welcome_screen.png)
>
...
>
> ![rhel6 language selection RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_language_selection.png)
>
...
> Once you have made your selection, click **Next** to continue.
>
> ![rhel6 keyboard configuration RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_keyboard_configuration.png)
>
> **9.6. Storage Devices**
>
...
>
> ![rhel6 storage devices RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_storage_devices.png)
>
...
>
> ![rhel6 set hostname RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_set_hostname.png)
>
...
>
> ![rhel6 timezone RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_timezone.png)
>
...
>
> ![rhel6 install root password RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_root_password.png)
>
...
>
> ![rhel6 install re initialize disk RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_re-initialize_disk.png)
>
...
>
> ![rhel6 install upgrade dialog RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_upgrade_dialog.png)
>
...
>
> ![rhel6 install grub upgrade RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_grub_upgrade.png)
>
...
>
> ![rhel6 install disk partitioning RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_disk_partitioning.png)
>
...
>
> ![rhel6 install encrypted install RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_encrypted_install.png)
>
...
>
> ![rhel6 install partitioning example RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_partitioning_example.png)
>
...
>
> ![rhel6 install create storage RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_create_storage.png)
>
...
>
> ![rhel6 install add partition RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_add_partition.png)
>
...
>
> ![ram recommendations RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-ram_recommendations.png)
>
...
>
> ![rhel6 minimum partition size RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_minimum_partition_size.png)
...
>
> ![rhel6 install write changes RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_write_changes.png)
>
...
>
> ![rhel6 install grub installer RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_grub_installer.png)
>
...
>
> ![rhel6 install advanced boot loader options RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_advanced_boot_loader_options.png)
...
>
> ![rhel6 install package selection RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_package_selection.png)
>
...
>
> ![rhel6 install package customize now RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_package_customize_now.png)
>
...
>
> ![rhel6 install packages installing RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_install_packages_installing.png)
>
...
![rhel6 boot install RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-rhel6_boot_install.png)

Then skipping the media check, I saw the welcome screen:

![welcome screen rhel5 install RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-welcome_screen_rhel5_install.png)

Here is how my language selection page looked like:

![lang selection rhel6 install RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-lang_selection_rhel6_install.png)

And here is how my Keyboard Selection screen looked like: ![key selection rhel6 install RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-key_selection_rhel6_install.png)

Then I re-initialized my disks:

![reinitialized disk rhel6 install RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-reinitialized_disk_rhel6_install.png)

I then set my timezone:

![tz sel rhel6 install RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-tz_sel_rhel6_install.png)

I then set the root password:

![root passwd rhel6 install RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-root_passwd_rhel6_install.png)

I then selected to use the whole driver and only selected the 20GB drive:

![partition type rhel6 install RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-partition_type_rhel6_install.png)

I then wrote the changes to disk:

![write changes to disk rhel6 install RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-write_changes_to_disk_rhel6_install.png)

After all the formatting and partition setup the installation process started:

![starting installation rhel6 install RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-starting_installation_rhel6_install.png)

and then the packages started to install:

![package installing rhel6 install RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-package_installing_rhel6_install.png)

After the packages finished installing I saw the following:

![installation finished rhel6 install RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-installation_finished_rhel6_install.png)

When the OS rebooted, I saw the following:

![reboot after rhel6 install RHCSA and RHCE Chapter 1   Installation](http://assets.virtuallyhyper.com/2012-12-reboot_after_rhel6_install.png)
