...
author: karim
comments: true
date: 2012-09-05 01:21:12+00:00
layout: post
slug: vmware-workstation-9-on-fedora-17-cause-kernel-panic-with-eip-is-at-hostif_saferdmsr0x110x20-vmmon
title: VMware Workstation 9 on Fedora 17 Causes Kernel Error with Message "EIP is
  at HostIF_SafeRDMSR+0x11/0x20 [vmmon]"
wordpress_id: 3405
categories:
- Home Lab
- OS
...
From that thread I found VMware Community [2103048](http://communities.vmware.com/message/2103048). That had a link to the [patch](http://communities.vmware.com/servlet/JiveServlet/download/2103172-94260/vmware9_kernel35_patch.tar.bz2) for this issue. I downloaded the patch:
