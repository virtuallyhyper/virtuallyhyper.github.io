...
author: jarret
comments: true
date: 2012-09-22 18:26:23+00:00
layout: post
slug: esxi-4-1-wait-for-local-vsa-to-start-before-starting-other-vms
...
The rc.local on the host calls all of the scripts in /etc/rc.local.d. It would be great to just put a script in /etc/rc.local.d. The problem is that any file we add there will not be persistent. Check out [this blog post](http://www.virtuallyghetto.com/2011/08/how-to-persist-configuration-changes-in.html) on other ways to make the files persistent.
...
624    vsa                 [ssd1] vsa/vsa.vmx                                      solaris10_64Guest         vmx-07  
