...
>
> ![apache config RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-apache-config.png)
>
...
>
> ![apache vh options RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-apache-vh-options.png)
>
...
>
> ![apache allowoverride options RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-apache-allowoverride-options.png)
>
...
>
> ![apache order options RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-apache-order-options.png)
>
...
![rhel1 apache elinks RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-rhel1-apache-elinks.png)
...
![rhel1 apache chrome RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-rhel1-apache-chrome.png)
...
![rhel1 apache with dir elinks RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-rhel1-apache-with-dir-elinks.png)
...
![apache denied access RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-apache-denied-access.png)
...
![apache auth required RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-apache-auth-required.png)
...
![apache vh elinks RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-apache-vh-elinks.png)
...
![genkey p1 RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-genkey-p1.png)

After that you can choose the size of the private key (I went with 2048):

![genkey p2 RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-genkey-p2.png)

Then the generation of the private key will start:

![genkey p3 RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-genkey-p3.png)

If it takes a while to generate random data:

![genkey p4 RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-genkey-p4.png)
...
![genkey p5 RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-genkey-p5.png)

I just wanted to create a self signed SSL certificate, so I selected **NO** and then it wanted to encrypt the private key:

![genkey p6 RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-genkey-p6.png)
...
![genkey p7 RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-genkey-p7.png)
...
![rhel1 elinks https RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-rhel1-elinks-https.png)
...
![rhel1 https chrome RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-rhel1-https-chrome.png)
...
![rhel1 elinks blocked2 RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-rhel1-elinks-blocked2.png)
...
![elinks thru squid proxy RHCSA and RHCE Chapter 14 – Web Services](http://assets.virtuallyhyper.com/2014-03-elinks-thru-squid-proxy.png)
