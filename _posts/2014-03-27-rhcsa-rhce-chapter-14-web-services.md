...
author: karim
comments: true
date: 2014-03-27 15:56:58+00:00
layout: post
slug: rhcsa-rhce-chapter-14-web-services
...
> 
> [![apache-config](http://virtuallyhyper.com/wp-content/uploads/2014/03/apache-config.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/apache-config.png)
> 
> 
...
> ****  
  ...
  The __ directive allows you to apply certain directives to a particular directory only. It takes the following form:
> 
> 
...
> 
> **Example 16.1. Using the  directive**
> 
> 
...
> ****  
  ...
  The __ directive allows you to apply certain directives to a particular URL only. It takes the following form:
> 
> 
...
> 
> **Example 16.4. Using the  directive**
> 
> 
...
> ****  
  ...
  The __ directive allows you apply certain directives to particular virtual hosts only. It takes the following form:
> 
> 
...
> 
> [![apache-vh-options](http://virtuallyhyper.com/wp-content/uploads/2014/03/apache-vh-options.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/apache-vh-options.png)
> 
> 
  
  
> 
> **Example 16.6. Using the  directive**
> 
> 
...
> **AccessFileName**  
  ...
  The _AccessFileName_ directive allows you to specify the file to be used to customize access control information for each directory. It takes the following form:
> 
> 
...
> **Alias**  
  ...
  The _Alias_ directive allows you to refer to files and directories outside the default directory specified by the **DocumentRoot** directive. It takes the following form:
> 
> 
...
> **Allow**  
  ...
  The _Allow_ directive allows you to specify which clients have permission to access a given directory. It takes the following form:
> 
> 
...
> **AllowOverride**  
  ...
  The _AllowOverride_ directive allows you to specify which directives in a **.htaccess** file can override the default configuration. It takes the following form:
> 
> 
...
> 
> [![apache-allowoverride-options](http://virtuallyhyper.com/wp-content/uploads/2014/03/apache-allowoverride-options.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/apache-allowoverride-options.png)
> 
> 
...
> **Deny**  
  ...
  The _Deny_ directive allows you to specify which clients are denied access to a given directory. It takes the following form:
> 
> 
...
> **DocumentRoot**  
  ...
  The _DocumentRoot_ directive allows you to specify the main directory from which the content is served. It takes the following form:
> 
> 
...
> **Order**  
  ...
  The _Order_ directive allows you to specify the order in which the **Allow** and **Deny** directives are evaluated. It takes the following form:
> 
> 
...
> 
> [![apache-order-options](http://virtuallyhyper.com/wp-content/uploads/2014/03/apache-order-options.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/apache-order-options.png)
> 
> 
...
> **ServerName**  
  ...
  The _ServerName_ directive allows you to specify the hostname and the port number of a web server. It takes the following form:
> 
> 
...
> **ServerRoot**  
  ...
  The _ServerRoot_ directive allows you to specify the directory in which the server operates. It takes the following form:
> 
> 
...
[![rhel1-apache-elinks](http://virtuallyhyper.com/wp-content/uploads/2014/03/rhel1-apache-elinks.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/rhel1-apache-elinks.png)
...
[![rhel1-apache-chrome](http://virtuallyhyper.com/wp-content/uploads/2014/03/rhel1-apache-chrome.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/rhel1-apache-chrome.png)





Now let's create a sub-directory under the _DirectoryRoot_ (**/var/www/html**) and create another html file there:
...
[![rhel1-apache-with-dir-elinks](http://virtuallyhyper.com/wp-content/uploads/2014/03/rhel1-apache-with-dir-elinks.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/rhel1-apache-with-dir-elinks.png)
...
[![apache-denied-access](http://virtuallyhyper.com/wp-content/uploads/2014/03/apache-denied-access.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/apache-denied-access.png)
...
[![apache-auth-required](http://virtuallyhyper.com/wp-content/uploads/2014/03/apache-auth-required.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/apache-auth-required.png)
...
[![apache-vh-elinks](http://virtuallyhyper.com/wp-content/uploads/2014/03/apache-vh-elinks.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/apache-vh-elinks.png)
...
[![genkey-p1](http://virtuallyhyper.com/wp-content/uploads/2014/03/genkey-p1.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/genkey-p1.png)
...
[![genkey-p2](http://virtuallyhyper.com/wp-content/uploads/2014/03/genkey-p2.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/genkey-p2.png)
...
[![genkey-p3](http://virtuallyhyper.com/wp-content/uploads/2014/03/genkey-p3.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/genkey-p3.png)
...
[![genkey-p4](http://virtuallyhyper.com/wp-content/uploads/2014/03/genkey-p4.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/genkey-p4.png)
...
[![genkey-p5](http://virtuallyhyper.com/wp-content/uploads/2014/03/genkey-p5.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/genkey-p5.png)
...
[![genkey-p6](http://virtuallyhyper.com/wp-content/uploads/2014/03/genkey-p6.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/genkey-p6.png)
...
[![genkey-p7](http://virtuallyhyper.com/wp-content/uploads/2014/03/genkey-p7.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/genkey-p7.png)
...
[![rhel1-elinks-https](http://virtuallyhyper.com/wp-content/uploads/2014/03/rhel1-elinks-https.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/rhel1-elinks-https.png)
...
[![rhel1-https-chrome](http://virtuallyhyper.com/wp-content/uploads/2014/03/rhel1-https-chrome.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/rhel1-https-chrome.png)
...
[![rhel1-elinks-blocked2](http://virtuallyhyper.com/wp-content/uploads/2014/03/rhel1-elinks-blocked2.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/rhel1-elinks-blocked2.png)
...
[![elinks-thru-squid-proxy](http://virtuallyhyper.com/wp-content/uploads/2014/03/elinks-thru-squid-proxy.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/elinks-thru-squid-proxy.png)
