...
![grub with single RHCSA and RHCE Chapter 2 System Initialization](http://assets.virtuallyhyper.com/2013-01-grub_with_single.png)

Selecting that entry from GRUB yielded in the OS booting into *single* user mode, like so:

![boot single user mode RHCSA and RHCE Chapter 2 System Initialization](http://assets.virtuallyhyper.com/2013-01-boot_single_user_mode.png)
