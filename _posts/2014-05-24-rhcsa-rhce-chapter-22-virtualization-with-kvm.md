...
![kvm-overview.png](http://assets.virtuallyhyper.com/2014-05-kvm-overview.png)
...
> 	
> 	![virt-host-select-rhel-install](http://assets.virtuallyhyper.com/2014-05-virt-host-select-rhel-install.png)
> 	
...
> 
> ![virt-group-pkgs](http://assets.virtuallyhyper.com/2014-05-virt-group-pkgs.png)
> 
...
![virt-viewer-launched-x-forward](http://assets.virtuallyhyper.com/2014-05-virt-viewer-launched-x-forward.png)
...
![vncviewer-connected-to-kvm-vm](http://assets.virtuallyhyper.com/2014-05-vncviewer-connected-to-kvm-vm.png)
...
> 
> 	![virt-man-p1](http://assets.virtuallyhyper.com/2014-05-virt-man-p1.png)
> 
...
> 
> 	![virt-man-p2](http://assets.virtuallyhyper.com/2014-05-virt-man-p2.png)
> 
...
> 
> 	![virt-man-p3](http://assets.virtuallyhyper.com/2014-05-virt-man-p3.png)
> 
> 	![virt-man-p4](http://assets.virtuallyhyper.com/2014-05-virt-man-p4.png)
> 
...
> 
> 	![virt-man-p5](http://assets.virtuallyhyper.com/2014-05-virt-man-p5.png)
> 
> 7. Configure storage
> 
> 	Assign storage to the guest virtual machine.
> 
> 	![virt-man-p5-5.png](http://assets.virtuallyhyper.com/2014-05-virt-man-p5-5.png)
> 
...
> 
> 	![virt-man-p6](http://assets.virtuallyhyper.com/2014-05-virt-man-p6.png)
> 
> 
...
![virt-man-launched](http://assets.virtuallyhyper.com/2014-05-virt-man-launched.png)
...
![virt-man-new-vm-p1](http://assets.virtuallyhyper.com/2014-05-virt-man-new-vm-p1.png)
...
![virt-man-select-centos-iso](http://assets.virtuallyhyper.com/2014-05-virt-man-select-centos-iso.png)

Then select the **OS Type** and **Version**. After done, it should look like this:

![virt-man-os-selected](http://assets.virtuallyhyper.com/2014-05-virt-man-os-selected.png)

Click **Forward**, select **RAM** and **CPU** settings, it should look like this:

![virt-man-ram-cpu-settings](http://assets.virtuallyhyper.com/2014-05-virt-man-ram-cpu-settings.png)

Click Forward and select the disk size:

![virt-man-vm-disk-size](http://assets.virtuallyhyper.com/2014-05-virt-man-vm-disk-size.png)

Click Forward and you should see the final page:

![virt-man-final-page](http://assets.virtuallyhyper.com/2014-05-virt-man-final-page.png)

Upon clicking **Finish** you will see the console of the VM:

![virt-man-console-open-after-install](http://assets.virtuallyhyper.com/2014-05-virt-man-console-open-after-install.png)

You will also see the VM in the Virt-Manager's Inventory:

![virt-man-centos-running](http://assets.virtuallyhyper.com/2014-05-virt-man-centos-running.png)

If you proceed with the VM install, here is how the disk setup page will look like:

![virt-man-centos-install-disk-page](http://assets.virtuallyhyper.com/2014-05-virt-man-centos-install-disk-page.png)

After the install is finished, you will see the OS booted up:

![virt-man-os-booted](http://assets.virtuallyhyper.com/2014-05-virt-man-os-booted.png)
...
![ip-command-within-the-vm-virt-man](http://assets.virtuallyhyper.com/2014-05-ip-command-within-the-vm-virt-man.png)
