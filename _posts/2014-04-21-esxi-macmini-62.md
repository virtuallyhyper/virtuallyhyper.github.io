...
![installing unetbootin ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-installing-unetbootin.png)

You can see it takes care of most of the setup. After it's finished you will see the following:

![unetbootin finished ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-unetbootin-finished.png)
...
![mac mini boot screen 1024x577 ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-mac-mini-boot-screen.jpg)

Select the "**EFI Boot**" option and the installer will start:

![esxi installer started 1024x305 ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-esxi-installer-started.jpg)

It will ask you which drive to install ESXi, I chose the local SSD drive:

![esxi select disk g 1024x513 ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-esxi-select-disk_g.jpg)

After that the installer will start:

![esxi installing g 1024x261 ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-esxi-installing_g.jpg)

And after the install is successful, you should see the following:

![esxi installed g 1024x517 ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-esxi-installed_g.jpg)

Click Enter to reboot and after it reboots you should see the default ESXi console:

![esxi reboot loca gl 720x1024 ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-esxi-reboot-loca_gl.jpg)
...
![esxtop nfc copy ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-esxtop-nfc-copy.png)
...
![powercli ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-powercli.png)

After installing PowerCLI and launching it, I saw the following warning:

![powercli warning policy ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-powercli-warning-policy.png)
...
![powercli started ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-powercli-started.png)
...
![copy disk esxtop g ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-copy-disk-esxtop_g.png)
...
![powecli copy command ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-powecli-copy-command.png)

Also checked out **esxtop** on the new host and the speeds were similar:

![copy disk macm esxtop g 1024x67 ESXi on MacMini 6,2](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-04-copy-disk-macm-esxtop_g.png)
