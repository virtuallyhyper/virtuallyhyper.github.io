...
![lm sensors devices asus Monitor Thermal Sensors With lm sensors](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-lm-sensors-devices-asus.png)
...
I wanted to check out the **exynos5250** manual to see what the thermal sensors were on the board and I found [this](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-Exynos_5_Dual_User_Manaul_Public_REV100-0.pdf) manual, but it didn't shed much light. It just said this:
...
I then ran into this presentation: [A simplified thermal framework for ARM platforms](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-A_New_Simplified_Thermal_Framework_For_ARM_Platforms.pdf). Here are some interesting concepts:
...
It seems that thermal monitoring is a little different on the SOC systems. I then ran into this interesting presentation: [PDF](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-Thermal_Mgmt_using_Generic_thermal_fw.pdf) (thermal zones, cooling devices, and other aspects). Here is a high level overview of the concepts:

![kernel thermal overview Monitor Thermal Sensors With lm sensors](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-kernel_thermal_overview.png)

### Linux Thermal Zones

From the same [PDF](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-Thermal_Mgmt_using_Generic_thermal_fw.pdf), here is an example of a thermal zone:

![Thermal zone Monitor Thermal Sensors With lm sensors](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-Thermal_zone.png)
...
For the above concepts there are corresponding **sysfs** nodes. From the same [PDF](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-Thermal_Mgmt_using_Generic_thermal_fw.pdf):
...
I then ran into this: [Inducing Thermal-Awareness in Multicore Systems Using Networks-on-Chip](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-Inducing_thermal_awareness-InSOC.pdf). From that article:
...
![thermal sensors on soc Monitor Thermal Sensors With lm sensors](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-thermal_sensors_on_soc.png)
...
![exynos thermal driver Monitor Thermal Sensors With lm sensors](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-exynos_thermal_driver.png)
...
![i stat dashboard Monitor Thermal Sensors With lm sensors](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-i_stat_dashboard.png)
...
*   [Service Source MacBook Pro](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-macbook-pro-service-manual.pdf)
*   [MacBook Pro 15-inch Repair Guide](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-15-inch-macbook-pro-manual.pdf)
*   [Apple Technician Guide MacBook Pro 15](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-mbp15_mid10.pdf)
...
![cpu chip1 Monitor Thermal Sensors With lm sensors](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-cpu_chip1.png)
...
![powertop1 Monitor Thermal Sensors With lm sensors](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-powertop1.png)
...
As I was labeling the sensors I came across some interesting acronyms. The first one, PECI, is described in ["Intel Celeron Mobile Processor P4000 and U3000 Series Datasheet"](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-celeron-mobile-p4000-u3000-datasheet.pdf). From that PDF:
...
From the [Apple Technician Guide MacBook Pro 15](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-mbp15_mid10.pdf), here is a good diagram:

![macbookpro 15 PCH Monitor Thermal Sensors With lm sensors](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-macbookpro_15_PCH.png)

So we can see that most of the components go through the PCH. Also from ["Intel 7 Series / C216 Chipset Platform Controller Hub (PCH)"](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-7-series-chipset-pch-thermal-design-guide.pdf) here is a table of all the components that connect to the PCH:

![PCH Components core I7 Monitor Thermal Sensors With lm sensors](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-09-PCH_Components_core_I7.png)
