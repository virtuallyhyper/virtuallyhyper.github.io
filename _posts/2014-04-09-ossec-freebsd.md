...
![ossec architecture OSSEC on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-ossec-architecture.png)
...
![ossec web ui OSSEC on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-ossec-web-ui.png)

It will have all the alerts on that page. You can also check out any files that have changed recently:

![ossec web ui integrity OSSEC on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-ossec-web-ui-integrity.png)
...
![select splunk for ossec OSSEC on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-select-splunk-for-ossec.png)

Upon the selecting the *OSSEC* App and selecting the dashboard you will see the following:

![ossec app splunk plots OSSEC on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-ossec-app-splunk-plots.png)

You can also see any files that have been changed from here:

![ossec splunk file changes g OSSEC on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-ossec-splunk-file-changes_g.png)
...
![out pty devices ossec splunk OSSEC on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-out-pty-devices-ossec-splunk.png)
...
![active clients ossec splunk OSSEC on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-active-clients-ossec-splunk.png)

That looked good. Checking out the Agent status dashboard and I saw the following:

![ossec agent status OSSEC on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-ossec-agent-status.png)

Then going to the Agent Coverage dashboard, I saw the following:

![agent coverage ossec splunk OSSEC on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-agent-coverage-ossec-splunk.png)

There were a bunch of new reports created which provided a bunch of cool information:

![ossec splunk reports1 OSSEC on FreeBSD](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2014-03-ossec-splunk-reports1.png)
