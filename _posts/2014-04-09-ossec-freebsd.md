...
author: karim
comments: true
date: 2014-04-09 15:12:04+00:00
layout: post
slug: ossec-freebsd
...
[![ossec-architecture](http://virtuallyhyper.com/wp-content/uploads/2014/03/ossec-architecture.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/ossec-architecture.png)
...
The port actually needs **gcc** to compile the software. I already had _gcc47_ installed from the [Samhain](http://virtuallyhyper.com/2014/03/install-samhain-beltane-freebsd) install, so I was all ready. To install the software, I ran the following:
...
That repository also had a **zabbix** package, which I already had installed from the _updates_ repository:
...
Instead of overriding those packages, I just **excluded** the _zabbix_ packages from the **atomic** repository. This is done by adding the following to the **/etc/yum.repos.d/atomic.repo** file (under the **atomic** section):
...
On the server side you should see an _alert_ similar to this:
...
[![ossec-web-ui](http://virtuallyhyper.com/wp-content/uploads/2014/03/ossec-web-ui.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/ossec-web-ui.png)
...
[![ossec-web-ui-integrity](http://virtuallyhyper.com/wp-content/uploads/2014/03/ossec-web-ui-integrity.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/ossec-web-ui-integrity.png)
...
I was already running **splunk** on my FreeBSD host (check out the instruction on that setup from [this](http://virtuallyhyper.com/2013/12/installing-splunk-freebsd/) post). After you download the app from [here](http://apps.splunk.com/app/300/), extract it and move it to the _splunk_ install:
...
[![select-splunk-for-ossec](http://virtuallyhyper.com/wp-content/uploads/2014/03/select-splunk-for-ossec.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/select-splunk-for-ossec.png)





Upon the selecting the _OSSEC_ App and selecting the dashboard you will see the following:





[![ossec-app-splunk-plots](http://virtuallyhyper.com/wp-content/uploads/2014/03/ossec-app-splunk-plots.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/ossec-app-splunk-plots.png)
...
[![ossec-splunk-file-changes_g](http://virtuallyhyper.com/wp-content/uploads/2014/03/ossec-splunk-file-changes_g.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/ossec-splunk-file-changes_g.png)
...
[![out-pty-devices-ossec-splunk](http://virtuallyhyper.com/wp-content/uploads/2014/03/out-pty-devices-ossec-splunk.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/out-pty-devices-ossec-splunk.png)
...
[![active-clients-ossec-splunk](http://virtuallyhyper.com/wp-content/uploads/2014/03/active-clients-ossec-splunk.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/active-clients-ossec-splunk.png)
...
[![ossec-agent-status](http://virtuallyhyper.com/wp-content/uploads/2014/03/ossec-agent-status.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/ossec-agent-status.png)
...
[![agent-coverage-ossec-splunk](http://virtuallyhyper.com/wp-content/uploads/2014/03/agent-coverage-ossec-splunk.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/agent-coverage-ossec-splunk.png)
...
[![ossec-splunk-reports](http://virtuallyhyper.com/wp-content/uploads/2014/03/ossec-splunk-reports1.png)](http://virtuallyhyper.com/wp-content/uploads/2014/03/ossec-splunk-reports1.png)
