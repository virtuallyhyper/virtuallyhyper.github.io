...
![pogoplug loggedin Backing Up with Rsync to Pogoplug](http://assets.virtuallyhyper.com/2013-09-pogoplug_loggedin.png)
...
![pogoplug com security Backing Up with Rsync to Pogoplug](http://assets.virtuallyhyper.com/2013-09-pogoplug_com_security.png)
...
![pci database Backing Up with Rsync to Pogoplug](http://assets.virtuallyhyper.com/2013-09-pci_database.png)

Then clicking on that device:

![vendor ID pcie Backing Up with Rsync to Pogoplug](http://assets.virtuallyhyper.com/2013-09-vendor_ID_pcie.png)
...
![botsync config Backing Up with Rsync to Pogoplug](http://assets.virtuallyhyper.com/2013-09-botsync_config.png)
