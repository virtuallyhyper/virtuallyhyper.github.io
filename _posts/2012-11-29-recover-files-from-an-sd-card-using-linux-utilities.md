...
![photo_rec_screen_1](http://assets.virtuallyhyper.com/2012-11-photo_rec_screen_1.png)

After I selected 'proceed', I saw a screen which determined my partition type:

![photorec_part_window](http://assets.virtuallyhyper.com/2012-11-photorec_part_window.png)
...
![photorec_screen_3](http://assets.virtuallyhyper.com/2012-11-photorec_screen_3.png)

At this screen it's asking you to choose the partition type. My SD Card used to be Fat32, so I selected the 'other' option:

![photorec_free_vs_whole](http://assets.virtuallyhyper.com/2012-11-photorec_free_vs_whole.png)
...
![photorec_select_dir](http://assets.virtuallyhyper.com/2012-11-photorec_select_dir.png)
...
![photorec_progress](http://assets.virtuallyhyper.com/2012-11-photorec_progress.png)

After the process finished I saw the following:

![photorec_recovery_finished](http://assets.virtuallyhyper.com/2012-11-photorec_recovery_finished.png)
