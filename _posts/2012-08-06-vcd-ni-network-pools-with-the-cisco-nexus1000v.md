...
![vsm_multicast_settings](http://assets.virtuallyhyper.com/2012-08-vsm_multicast_settings.png)
...
![nsm_connection](http://assets.virtuallyhyper.com/2012-08-nsm_connection.png)
...
![vcloud_add_net_pool_1](http://assets.virtuallyhyper.com/2012-08-vcloud_add_net_pool_1.png)
...
![conf_ib_pool](http://assets.virtuallyhyper.com/2012-08-conf_ib_pool.png)
...
![open_org](http://assets.virtuallyhyper.com/2012-08-open_org.png)
...
4.  Right Click on your Virtual Datacenter and select "Properties"![prop_vdc](http://assets.virtuallyhyper.com/2012-08-prop_vdc.png)
5.  Click on the Network Pool Tab
6.  Select the VCD-NI Pool that you just created![change_net_pool_of_vdc](http://assets.virtuallyhyper.com/2012-08-change_net_pool_of_vdc.png)
...
![new_vapp_with_vapp_network](http://assets.virtuallyhyper.com/2012-08-new_vapp_with_vapp_network.png)
...
![add_org_network](http://assets.virtuallyhyper.com/2012-08-add_org_network.png)

Then Follow the wizard:

1.  Select what type of Network you would like this to be (internal, routed, or direct)
2.  Select the N1K pool that we created to be used by this Org network![select_pool_for_org_network](http://assets.virtuallyhyper.com/2012-08-select_pool_for_org_network.png)
...
![vapp_conn_to_org_network_1](http://assets.virtuallyhyper.com/2012-08-vapp_conn_to_org_network_1.png)
