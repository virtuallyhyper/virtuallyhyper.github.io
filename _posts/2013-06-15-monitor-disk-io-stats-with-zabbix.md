...
![zabbiz reg expression g Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbiz_reg_expression_g.png)

Then click "Create New Regular Expression" and under "Expressions", click "New" and add the following:

![zabbiz reg expression create Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbiz_reg_expression_create.png)

Save that and on the left side, name the Regular Expression and do a test to make sure it works:

![zabbiz reg expression test Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbiz_reg_expression_test.png)

and also put in a partition to make sure it fails:

![zabbiz reg expression test fail Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbiz_reg_expression_test_fail.png)

Save that and if you go back to the regular expression list you will see yours there:

![zabbiz reg expression list Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbiz_reg_expression_list.png)
...
![zabbix create template Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbix_create_template.png)
...
![zabbix templates Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbix_templates.png)
...
![zabbix discovery rule Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbix_discovery_rule.png)

Save that and if you go back to the discovery rules you will see the following:

![zabbix discovery rule list Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbix_discovery_rule_list.png)
...
![zab item prototype later Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zab-item-prototype-later.png)

I added both read and write latency. Here is my Disk Rate in Bps:

![zab item prototype after dr Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zab-item-prototype-after-dr.png)
...
![zabbix itemprototypes list Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbix_itemprototypes_list.png)
...
![zabbix graphprototypes latency Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbix_graphprototypes_latency.png)

Using the same technique I created 3 graph prototypes:

![zabbix graphprototypes list Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbix_graphprototypes_list.png)
...
![zabbix graph lists fedora g Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbix_graph_lists_fedora_g.png)

and here is one graph:

![zabbix disk rate fedora Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbix_disk_rate_fedora.png)

And here are the available graphs for my Ubuntu which just had one drive in it:

![zabbix graph lists ub g Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbix_graph_lists_ub_g.png)

and here is latency for the disk:

![zabbix disk latency ubuntu Monitor Disk IO Stats with Zabbix](http://assets.virtuallyhyper.com/2013-06-zabbix_disk_latency_ubuntu.png)
