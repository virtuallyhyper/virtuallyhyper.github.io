...
![snorby login Snort On Debian](http://assets.virtuallyhyper.com/2014-04-snorby-login.png)
...
![snorby dashboard Snort On Debian](http://assets.virtuallyhyper.com/2014-04-snorby-dashboard.png)

If you go to the events tab, you will see the specifics:

![snorby events 1024x229 Snort On Debian](http://assets.virtuallyhyper.com/2014-04-snorby-events.png)
...
![snort suggested setup Snort On Debian](http://assets.virtuallyhyper.com/2014-04-snort-suggested-setup.png)

### First Interesting Alert

After a couple of days, I saw the following alert:

![php vulnerability Snort On Debian](http://assets.virtuallyhyper.com/2014-04-php-vulnerability.png)
