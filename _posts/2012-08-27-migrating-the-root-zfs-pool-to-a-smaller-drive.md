...
![create_new_partition](http://assets.virtuallyhyper.com/2012-08-create_new_partition.png)

and then select the partition type:

![select_partition_type](http://assets.virtuallyhyper.com/2012-08-select_partition_type.png)

then select to use the whole partition (100%):

![select_to_use_100](http://assets.virtuallyhyper.com/2012-08-select_to_use_100.png)

Then let's go ahead and activate the partition:

![activate_the_partition](http://assets.virtuallyhyper.com/2012-08-activate_the_partition.png)

and finally let's write the changes to disk:

![commit_changes](http://assets.virtuallyhyper.com/2012-08-commit_changes.png)
...
![select_none_to_boot_from](http://assets.virtuallyhyper.com/2012-08-select_none_to_boot_from.png)

then exit and commit the changes:

![deactivate-bootable-parition](http://assets.virtuallyhyper.com/2012-08-deactivate-bootable-parition1.png)
