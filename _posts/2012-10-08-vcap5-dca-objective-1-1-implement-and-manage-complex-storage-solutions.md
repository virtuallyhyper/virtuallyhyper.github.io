...
>
> ![raid0 wiki VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-raid0-wiki.png)
...
>
> ![raid 1 wiki VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-raid-1-wiki.png)
...
>
> ![raid 5 wiki VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-raid-5-wiki.png)
...
![raid10 wiki VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-raid10-wiki.png)
...
![raid io impact VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-raid_io_impact.png)
...
![vmdk types VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-vmdk-types.png)
...
![vm direct path io VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-vm-direct_path_io.png)
...
![npiv cisco VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-npiv_cisco.png)
...
![npiv slog VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-npiv_slog.png)
...
![data type with characteristics VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-data_type_with_characteristics.png)

and from the same site:

![raid type with factors VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-raid_type_with_factors.png)
...
![storage filters VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-storage-filters.png)
...
> ![key filter name VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-key-filter-name.png)
...
![application io workloads VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-application_io_workloads.png)
...
> ![storage profiles user defined VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-storage_profiles_user_defined.png)
> 4 Click OK.

First go to the Home Screen:

![home vmstorage profiles VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-home_vmstorage_profiles.png)

Then click on VM Storage Profiles:

![vm storage profiles VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-vm_storage_profiles.png)

Then Click "Manage Storage Capabilities":

![manage storage capabilities VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-manage_storage_capabilities.png)

Fill out all the necessary fields and click ok:

![add storage capability VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-add_storage_capability.png)

and finally you should see this:
![added storage capability VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-added_storage_capability.png)
...
>
> ![associate st profile with ds VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-associate_st_profile_with_ds.png)
>
...
![right click datastore VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-right_click_datastore.png)

Then select your capability to be assigned to this datastore:

![assign storage capability to datastore VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-assign_storage_capability_to_datastore.png)

Then under Summary of the Datastore you will see your capability assigned:
![check assigned capability VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-check_assigned_capability.png)
...
![right click on datastore to umount VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-right_click_on_datastore_to_umount.png)

Click on "Unmount" and you will see the following screen:

![unmount datastore VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-unmount_datastore.png)
...
![detach path VCAP5 DCA Objective 1.1 – Implement and Manage Complex Storage Solutions ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-09-detach_path.png)
