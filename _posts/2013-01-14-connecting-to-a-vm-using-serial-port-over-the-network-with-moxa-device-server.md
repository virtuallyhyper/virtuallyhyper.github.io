...
author: karim
comments: true
date: 2013-01-14 18:24:06+00:00
layout: post
slug: connecting-to-a-vm-using-serial-port-over-the-network-with-moxa-device-server
title: Connecting to a VM using "Serial Port Over the Network" With a Moxa Device
  Server
wordpress_id: 5446
categories:
- Networking
...
[![VM_Serial_Connection_Over_Network](http://virtuallyhyper.com/wp-content/uploads/2012/12/VM_Serial_Connection_Over_Network.jpg)](http://virtuallyhyper.com/2013/01/connecting-to-a-vm-using-serial-port-over-the-network-with-moxa-device-server/vm_serial_connection_over_network/)
...
> 
> [![vserial_port_configuration](http://virtuallyhyper.com/wp-content/uploads/2012/12/vserial_port_configuration.png)](http://virtuallyhyper.com/2013/01/connecting-to-a-vm-using-serial-port-over-the-network-with-moxa-device-server/vserial_port_configuration/)
> 
> 
...
>   5. (Optional) Change the Device status settings.[![vserial_connected_box](http://virtuallyhyper.com/wp-content/uploads/2012/12/vserial_connected_box.png)](http://virtuallyhyper.com/2013/01/connecting-to-a-vm-using-serial-port-over-the-network-with-moxa-device-server/vserial_connected_box/)
> 
  
>   6. Select a connection type.[![options_for_serial_port](http://virtuallyhyper.com/wp-content/uploads/2012/12/options_for_serial_port.png)](http://virtuallyhyper.com/2013/01/connecting-to-a-vm-using-serial-port-over-the-network-with-moxa-device-server/options_for_serial_port/)
> 
...
>   4. On the host PC, connect to the NPort's Telnet console by entering telnet _nport's_ IP address at the command prompt. For example, if your NPort's IP address is 192.168.127.254, enter **telnet 192.168.127.254** at the command prompt. 
> 
...
[![vm_serial_port_conf](http://virtuallyhyper.com/wp-content/uploads/2012/12/vm_serial_port_conf.png)](http://virtuallyhyper.com/2013/01/connecting-to-a-vm-using-serial-port-over-the-network-with-moxa-device-server/vm_serial_port_conf/)
