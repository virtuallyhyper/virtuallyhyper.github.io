...
>
> ![scripted installation VCAP5 DCA Objective 9.1 – Install ESXi hosts with custom settings ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-scripted_installation.png)
>
...
>     ![image builder add software depot VCAP5 DCA Objective 9.1 – Install ESXi hosts with custom settings ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-image_builder_add_software_depot.png)
...
![5 0U1 offline bundle download VCAP5 DCA Objective 9.1 – Install ESXi hosts with custom settings ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-5_0U1_offline_bundle_download.png)

Once downloaded you will see the following:

![offline bundle downloaded VCAP5 DCA Objective 9.1 – Install ESXi hosts with custom settings ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-offline_bundle_downloaded.png)
...
![igb offline bundle VCAP5 DCA Objective 9.1 – Install ESXi hosts with custom settings ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-igb_offline_bundle.png)

After extracting the zip you see the following contents:

![igb driver extracted VCAP5 DCA Objective 9.1 – Install ESXi hosts with custom settings ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-igb_driver_extracted.png)
...
>     ![esxi boot screen VCAP5 DCA Objective 9.1 – Install ESXi hosts with custom settings ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-esxi_boot_screen.png)
...
> ![boot options esxi VCAP5 DCA Objective 9.1 – Install ESXi hosts with custom settings ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-boot_options_esxi.png)
...
>
> ![boot cfg options VCAP5 DCA Objective 9.1 – Install ESXi hosts with custom settings ](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2012-12-boot_cfg_options.png)
