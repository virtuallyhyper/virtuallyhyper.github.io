...
author: jarret
comments: true
date: 2012-08-13 20:22:16+00:00
layout: post
slug: files-created-for-a-test-failover-with-vsphere-replication
...
I have been writing a lot about SRM and vSphere Replication recently, but I have not written about how it all works. There is a great blog on [how vSphere Replication works here](http://blogs.vmware.com/uptime/2011/10/how-does-vsphere-replication-work.html). Personally I like to try it out and see what changes. One of the first things I did when learning vSphere Replication was look at the files that are modified during the test failover and configuring replication.
