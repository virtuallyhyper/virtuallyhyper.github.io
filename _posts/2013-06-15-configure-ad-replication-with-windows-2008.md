...
![site replication Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-site-replication.png)
...
![repl seq Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-repl_seq.png)
...
![ad wizard Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-ad_wizard.png)

Let's choose to "Add a domain controller to an existing domain":

![existing forest Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-existing_forest.png)

Enter the name of the Domain and enter the admin password for that Domain:

![enter domain name Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-enter_domain_name.png)

If the connection to the primary DC is successful, you will see the following:

![existing DC Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-existing_DC.png)

We won't be doing any inter-site setup, so selecting the default site name is okay here:

![default site ad setup Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-default_site_ad_setup.png)

Next let's setup a DNS server on the new DC and let's NOT make it Read only (RODC):

![additional dc options Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-additional_dc_options.png)

Next, let's go ahead and replicate the AD configuration from the primary DC:

![replicate data ad wizrd Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-replicate_data_ad_wizrd.png)

Click "Next" a couple of times and at the end, you will get to the summary page:

![ad wizard summary Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-ad_wizard_summary.png)

After you click "Next", the replication will start:

![replicating data Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-replicating_data.png)

After it's done, you will see the following:

![ad wizard finished Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-ad_wizard_finished.png)
...
![dssite msc Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-dssite_msc.png)
...
![dsa msc new user Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-dsa_msc_new_user.png)

Let's call our user "test":

![test user dsa msc Configure AD Replication with Windows 2008](https://googledrive.com/host/0BxotWZXnwSAGSS1qRE02eWVrU28/2013-05-test_user_dsa_msc.png)
